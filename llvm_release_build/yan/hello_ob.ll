...
; <label>:9:                                      ; preds = %16, %0
  ...
  %11 = call i1 @ext_callee(i32 40, i32 %10, i32 100, i8* blockaddress(@main, %12), i8* blockaddress(@main, %19))
...
; <label>:19:                                     ; preds = %9
  ...
  %21 = call i1 @ext_callee(i32 40, i32 %20, i32 100, i8* blockaddress(@main, %22), i8* blockaddress(@main, %26))
...
declare i1 @ext_callee(i32, i32, i32, i8*, i8*)
