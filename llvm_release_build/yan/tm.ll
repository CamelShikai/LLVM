...
@.str.14 = private unnamed_addr constant [31 x i8] c" Log:op:%d,op1:%d,op2:%d\1B[0m \0A\00", align 1
@.str.15 = private unnamed_addr constant [15 x i8] c"op1:%d op2:%d\0A\00", align 1
...
define zeroext i1 @ext_callee(i32, i32, i32) #0 {
  ...
  %11 = call %struct._IO_FILE* @fopen(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.12, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.13, i32 0, i32 0))
  store %struct._IO_FILE* %11, %struct._IO_FILE** %10, align 8
  %12 = load %struct._IO_FILE*, %struct._IO_FILE** %10, align 8
  %13 = load i32, i32* %5, align 4
  %14 = load i32, i32* %6, align 4
  %15 = load i32, i32* %7, align 4
  %16 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %12, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.14, i32 0, i32 0), i32 %13, i32 %14, i32 %15)
...
; <label>:18:                                     ; preds = %3
  ...
  %20 = call i32 @abs(i32 %19) #10
  %21 = icmp sgt i32 %20, 10000
  br i1 %21, label %26, label %22

; <label>:22:                                     ; preds = %18
  %23 = load i32, i32* %7, align 4
  %24 = call i32 @abs(i32 %23) #10
...
; <label>:26:                                     ; preds = %22, %18
  ...
  %30 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %27, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %28, i32 %29)
...
; <label>:44:                                     ; preds = %3
  ...
  %46 = call i32 @abs(i32 %45) #10
  %47 = icmp sgt i32 %46, 10000
  br i1 %47, label %52, label %48

; <label>:48:                                     ; preds = %44
  %49 = load i32, i32* %7, align 4
  %50 = call i32 @abs(i32 %49) #10
...
; <label>:52:                                     ; preds = %48, %44
  ...
  %56 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %53, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %54, i32 %55)
...
; <label>:60:                                     ; preds = %48
  ...
  %63 = call i32 @calculator(i32 %61, i32 %62, i8 signext 45)
...
; <label>:70:                                     ; preds = %3
  ...
  %72 = call i32 @abs(i32 %71) #10
  %73 = icmp sgt i32 %72, 10000
  br i1 %73, label %78, label %74

; <label>:74:                                     ; preds = %70
  %75 = load i32, i32* %7, align 4
  %76 = call i32 @abs(i32 %75) #10
...
; <label>:78:                                     ; preds = %74, %70
  ...
  %82 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %79, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %80, i32 %81)
...
; <label>:86:                                     ; preds = %74
  ...
  %89 = call i32 @calculator(i32 %87, i32 %88, i8 signext 45)
...
; <label>:104:                                    ; preds = %100, %96
  %105 = load %struct._IO_FILE*, %struct._IO_FILE** %10, align 8
  %106 = load i32, i32* %6, align 4
  %107 = load i32, i32* %7, align 4
  %108 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %105, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %106, i32 %107)
...
; <label>:112:                                    ; preds = %100
  ...
  %115 = call i32 @calculator(i32 %113, i32 %114, i8 signext 45)
...
; <label>:122:                                    ; preds = %3
  ...
  %124 = call i32 @abs(i32 %123) #10
  %125 = icmp sgt i32 %124, 10000
...
; <label>:130:                                    ; preds = %126, %122
  %131 = load %struct._IO_FILE*, %struct._IO_FILE** %10, align 8
  %132 = load i32, i32* %6, align 4
  %133 = load i32, i32* %7, align 4
  %134 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %131, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %132, i32 %133)
...
; <label>:156:                                    ; preds = %152, %148
  %157 = load %struct._IO_FILE*, %struct._IO_FILE** %10, align 8
  %158 = load i32, i32* %6, align 4
  %159 = load i32, i32* %7, align 4
  %160 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %157, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %158, i32 %159)
...
; <label>:164:                                    ; preds = %152
  ...
  %167 = call i32 @calculator(i32 %165, i32 %166, i8 signext 45)
...
; <label>:178:                                    ; preds = %174
  ...
  %180 = call i32 @abs(i32 %179) #10
  %181 = icmp sgt i32 %180, 10000
...
; <label>:182:                                    ; preds = %178, %174
  ...
  %186 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %183, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %184, i32 %185)
...
; <label>:190:                                    ; preds = %178
  ...
  %193 = call i32 @calculator(i32 %191, i32 %192, i8 signext 45)
...
; <label>:200:                                    ; preds = %3
  ...
  %202 = call i32 @abs(i32 %201) #10
  %203 = icmp sgt i32 %202, 10000
  br i1 %203, label %208, label %204

; <label>:204:                                    ; preds = %200
  %205 = load i32, i32* %7, align 4
  %206 = call i32 @abs(i32 %205) #10
  %207 = icmp sgt i32 %206, 10000
...
; <label>:208:                                    ; preds = %204, %200
  ...
  %212 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %209, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %210, i32 %211)
...
; <label>:216:                                    ; preds = %204
  ...
  %219 = call i32 @calculator(i32 %217, i32 %218, i8 signext 45)
...
; <label>:226:                                    ; preds = %3
  ...
  %228 = call i32 @abs(i32 %227) #10
  %229 = icmp sgt i32 %228, 10000
  br i1 %229, label %234, label %230

; <label>:230:                                    ; preds = %226
  %231 = load i32, i32* %7, align 4
  %232 = call i32 @abs(i32 %231) #10
  %233 = icmp sgt i32 %232, 10000
  br i1 %233, label %234, label %242

; <label>:234:                                    ; preds = %230, %226
  %235 = load %struct._IO_FILE*, %struct._IO_FILE** %10, align 8
  %236 = load i32, i32* %6, align 4
  %237 = load i32, i32* %7, align 4
  %238 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %235, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %236, i32 %237)
...
; <label>:242:                                    ; preds = %230
  ...
  %245 = call i32 @calculator(i32 %243, i32 %244, i8 signext 45)
  ...
  store i8 %251, i8* %8, align 1
  br label %279

; <label>:252:                                    ; preds = %3
  %253 = load i32, i32* %6, align 4
  %254 = call i32 @abs(i32 %253) #10
  %255 = icmp sgt i32 %254, 10000
  br i1 %255, label %260, label %256

; <label>:256:                                    ; preds = %252
  %257 = load i32, i32* %7, align 4
  %258 = call i32 @abs(i32 %257) #10
  %259 = icmp sgt i32 %258, 10000
...
; <label>:260:                                    ; preds = %256, %252
  ...
  %264 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %261, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.15, i32 0, i32 0), i32 %262, i32 %263)
...
; <label>:268:                                    ; preds = %256
  ...
  %271 = call i32 @calculator(i32 %269, i32 %270, i8 signext 45)
...
; <label>:279:                                    ; preds = %278, %268, %242, %216, %190, %164, %138, %112, %86, %60, %34
  %280 = load i8, i8* %8, align 1
  %281 = trunc i8 %280 to i1
  store i1 %281, i1* %4, align 1
  br label %282

; <label>:282:                                    ; preds = %279, %260, %234, %208, %182, %156, %130, %104, %78, %52, %26
