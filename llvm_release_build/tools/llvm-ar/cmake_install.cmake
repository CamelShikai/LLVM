# Install script for directory: /media/windows/win2/Research/llvm-project/llvm/tools/llvm-ar
...
if("${CMAKE_INSTALL_COMPONENT}" STREQUAL "llvm-ar" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/media/windows/win2/Research/llvm_release_build/bin/llvm-ar")
...
if("${CMAKE_INSTALL_COMPONENT}" STREQUAL "llvm-ranlib" OR NOT CMAKE_INSTALL_COMPONENT)
  include("/media/windows/win2/Research/llvm-project/llvm/cmake/modules/LLVMInstallSymlink.cmake")
endif()
