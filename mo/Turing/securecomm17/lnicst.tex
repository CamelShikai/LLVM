...
We choose two popular open source programs as source programs to verify effectiveness of our Turing machien obfuscator: compress tool bzip2\cite{bzip2} and regular expression engine slre\cite{slre}.
%
