...
Concolic testing is an advanced deobfuscation techniques aiming at finding bugs or vulnerbilities in software development through symbolic execution. Whereas, it is also used by adversaries to analyse or restore software inner logic eg. control flow graph. KLEE\cite{klee} is static analysis tool based on LLVM platform and it could generate enough test cases to ensure a code coverage threshhold. With the help of KLEE, it would be easy to conduct conduct automated deobfuscation. We chose KLEE as the deobfuscation tool to evaluation resilence of Turing Machine obfuscator.
\subsection{Stealth}
