...
# 79 "file_list.c"
    ...
    ((out >= 0) ? 0 : (daemon_assert_fail("out >= 0", "file_list.c", 85, __func__)));
    ((is_valid_dir(cur_dir)) ? 0 : (daemon_assert_fail("is_valid_dir(cur_dir)", "file_list.c", 86, __func__)));
    ((filespec != 
# 87 "file_list.c" 3 4
   ((void *)0)
# 87 "file_list.c"
   ) ? 0 : (daemon_assert_fail("filespec != ((void *)0)", "file_list.c", 87, __func__)));
...
# 167 "file_list.c"
    ...
    ((out >= 0) ? 0 : (daemon_assert_fail("out >= 0", "file_list.c", 170, __func__)));
    ((is_valid_dir(cur_dir)) ? 0 : (daemon_assert_fail("is_valid_dir(cur_dir)", "file_list.c", 171, __func__)));
    ((filespec != 
# 172 "file_list.c" 3 4
   ((void *)0)
# 172 "file_list.c"
   ) ? 0 : (daemon_assert_fail("filespec != ((void *)0)", "file_list.c", 172, __func__)));
...
# 219 "file_list.c" 3 4
                              __builtin_alloca (
# 219 "file_list.c"
                              sizeof(file_info_t) * glob_buf.gl_pathc
# 219 "file_list.c" 3 4
                              )
# 219 "file_list.c"
                                                                             ;
...
# 256 "file_list.c" 3 4
         0140000
# 256 "file_list.c"
                 : fdprintf(out, "s"); break;
     case 
# 257 "file_list.c" 3 4
         0120000
# 257 "file_list.c"
                : fdprintf(out, "l"); break;
     case 
# 258 "file_list.c" 3 4
         0060000
# 258 "file_list.c"
                : fdprintf(out, "b"); break;
     case 
# 259 "file_list.c" 3 4
         0040000
# 259 "file_list.c"
                : fdprintf(out, "d"); break;
     case 
# 260 "file_list.c" 3 4
         0020000
# 260 "file_list.c"
                : fdprintf(out, "c"); break;
     case 
# 261 "file_list.c" 3 4
         0010000
# 261 "file_list.c"
                : fdprintf(out, "p"); break;
...
# 305 "file_list.c"
 ...
 localtime_r(&file_info[i].stat.
# 309 "file_list.c" 3 4
                               st_mtim.tv_sec
# 309 "file_list.c"
                                       , &tm_now);
        age = difftime(now, file_info[i].stat.
# 310 "file_list.c" 3 4
                                             st_mtim.tv_sec
# 310 "file_list.c"
                                                     );
...
# 366 "file_list.c"
    ...
    ((fd >= 0) ? 0 : (daemon_assert_fail("fd >= 0", "file_list.c", 372, __func__)));
    ((fmt != 
# 373 "file_list.c" 3 4
   ((void *)0)
# 373 "file_list.c"
   ) ? 0 : (daemon_assert_fail("fmt != ((void *)0)", "file_list.c", 373, __func__)));
...
# 402 "file_list.c" 3 4
   ((void *)0)
# 402 "file_list.c"
   ) ? 0 : (daemon_assert_fail("filespec != ((void *)0)", "file_list.c", 402, __func__)));
...
# 431 "file_list.c" 3 4
   ((void *)0)
# 431 "file_list.c"
   ) ? 0 : (daemon_assert_fail("filespec != ((void *)0)", "file_list.c", 431, __func__)));
