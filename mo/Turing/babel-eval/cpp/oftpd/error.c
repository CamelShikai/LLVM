...
# 26 "error.c" 3 4
   ((void *)0)
# 26 "error.c"
   ) ? 0 : (daemon_assert_fail("err != ((void *)0)", "error.c", 26, __func__)));
    ((error_code >= 0) ? 0 : (daemon_assert_fail("error_code >= 0", "error.c", 27, __func__)));
    ((desc_fmt != 
# 28 "error.c" 3 4
   ((void *)0)
# 28 "error.c"
   ) ? 0 : (daemon_assert_fail("desc_fmt != ((void *)0)", "error.c", 28, __func__)));
...
# 33 "error.c"
    ...
    ((invariant(err)) ? 0 : (daemon_assert_fail("invariant(err)", "error.c", 35, __func__)));
}

int error_get_error_code(const error_t *err)
{
    ((invariant(err)) ? 0 : (daemon_assert_fail("invariant(err)", "error.c", 40, __func__)));
    return err->error_code;
}

const char *error_get_desc(const error_t *err)
{
    ((invariant(err)) ? 0 : (daemon_assert_fail("invariant(err)", "error.c", 46, __func__)));
    return err->desc;
}
