...
{
    int cond1, cond2;
    cond1 = red_cost < 0 && arc->ident == 1;
    if (cond1) {
        return 1;
    } else {
        cond2 = red_cost > 0 && arc->ident == 2;
        return cond2;
    }
...
static BASKET basket[50 +300 +1];
static BASKET *perm[50 +300 +1];
                              ...
                              cost_t *red_cost_of_bea )
{
    ...
    do
    {
        ...
        if( ++group_pos == nr_group )
            group_pos = 0;
        cond = basket_size < 50 && group_pos != old_group_pos;
    }
    while ( cond );
