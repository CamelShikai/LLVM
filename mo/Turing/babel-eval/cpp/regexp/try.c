...
char *argv[];
{
 ...
 if (argc > 2) {
  ...
  printf("%d", i);
  for (i = 1; i < 10; i++)
   if (r->startp[i] != ((void *)0) && r->endp[i] != ((void *)0))
    printf(" \\%d", i);
  printf("\n");
 }
 if (argc > 3) {
...
multiple()
{
 ...
 errreport = 1;
 lineno = 0;
 while (fgets(rbuf, sizeof(rbuf), stdin) != ((void *)0)) {
 ...
 lineno = 9990;
 errseen = ((void *)0);
 if (regcomp((char *)((void *)0)) != ((void *)0) || errseen == ((void *)0))
  complain("regcomp(NULL) doesn't complain", "");
 lineno = 9991;
 errseen = ((void *)0);
 if (regexec((regexp *)((void *)0), "foo") || errseen == ((void *)0))
 ...
 lineno = 9993;
 errseen = ((void *)0);
 if (regexec(r, (char *)((void *)0)) || errseen == ((void *)0))
  complain("regexec(..., NULL) doesn't complain", "");
 lineno = 9994;
 errseen = ((void *)0);
 regsub((regexp *)((void *)0), "foo", rbuf);
 if (errseen == ((void *)0))
  complain("regsub(NULL, ..., ...) doesn't complain", "");
 lineno = 9995;
 errseen = ((void *)0);
 regsub(r, (char *)((void *)0), rbuf);
 if (errseen == ((void *)0))
  complain("regsub(..., NULL, ...) doesn't complain", "");
 lineno = 9996;
 errseen = ((void *)0);
 regsub(r, "foo", (char *)((void *)0));
 if (errseen == ((void *)0))
  complain("regsub(..., ..., NULL) doesn't complain", "");
 lineno = 9997;
 errseen = ((void *)0);
 if (regexec(&badregexp, "foo") || errseen == ((void *)0))
