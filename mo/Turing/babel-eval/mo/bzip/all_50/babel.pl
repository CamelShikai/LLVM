...
babel__implicit_compressedStreamEOFc_30(2). 
 ...
 :- foreign(babel__implicit_ioErrorc_31(+integer, +integer, +integer)).
:- foreign(babel__implicit_ioErrorc_32(+integer)).
:- foreign(babel__implicit_ioErrorc_33(+integer)).
:- foreign(babel__implicit_ioErrorc_34(+integer)).

ioError(__CIL_GP_STDERR, __CIL_GP_PROGNAME, BABEL_RET) :- 


 BabelExp_56 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP3, BabelExp_56, 8),
BabelExp_57 is __CIL_GP_PROGNAME,
babelPtrR(__CIL_TMP4, BabelExp_57, 8),
babel__implicit_ioErrorc_31(__CIL_TMP3, '\\N%S: I/O OR OTHER ERROR, BAILING OUT.  POSSIBLE REASON FOLLOWS.\\N', __CIL_TMP4),
BabelExp_58 is __CIL_GP_PROGNAME,
babelPtrR(__CIL_TMP5, BabelExp_58, 8),
babel__implicit_ioErrorc_32(__CIL_TMP5),
babel__implicit_ioErrorc_33(0),
babel__implicit_ioErrorc_34(1). 

 :- foreign(babel__implicit_mySignalCatcherc_35(+integer, +integer, +integer)).
:- foreign(babel__implicit_mySignalCatcherc_36(+integer)).

mySignalCatcher(__CIL_GP_STDERR, __CIL_GP_PROGNAME, N, BABEL_RET) :- 


 BabelExp_59 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP4, BabelExp_59, 8),
BabelExp_60 is __CIL_GP_PROGNAME,
babelPtrR(__CIL_TMP5, BabelExp_60, 8),
babel__implicit_mySignalCatcherc_35(__CIL_TMP4, '\\N%S: CONTROL-C OR SIMILAR CAUGHT, QUITTING.\\N', __CIL_TMP5),
babel__implicit_mySignalCatcherc_36(1). 

 :- foreign(babel__implicit_mySIGSEGVorSIGBUScatcherc_37(+integer, +integer, +integer)).
:- foreign(babel__implicit_mySIGSEGVorSIGBUScatcherc_38(+integer, +integer, +integer)).
:- foreign(babel__implicit_mySIGSEGVorSIGBUScatcherc_39(+integer)).
:- foreign(babel__implicit_mySIGSEGVorSIGBUScatcherc_40(+integer)).
:- foreign(babel__implicit_mySIGSEGVorSIGBUScatcherc_41(+integer)).
:- foreign(babel__implicit_mySIGSEGVorSIGBUScatcherc_42(+integer)).

mySIGSEGVorSIGBUScatcher(__CIL_GP_OPMODE, __CIL_GP_STDERR, __CIL_GP_PROGNAME, N, BABEL_RET) :- 


 BabelExp_61 is __CIL_GP_OPMODE,
babelPtrR(__CIL_TMP7, BabelExp_61, 4),
...
(__CIL_TMP5 \= 0 ->
BabelExp_62 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP8, BabelExp_62, 8),
BabelExp_63 is __CIL_GP_PROGNAME,
babelPtrR(__CIL_TMP9, BabelExp_63, 8),
babel__implicit_mySIGSEGVorSIGBUScatcherc_37(__CIL_TMP8, '\\N%S: CAUGHT A SIGSEGV OR SIGBUS WHILST COMPRESSING.\\N\\N   POSSIBLE CAUSES ARE (MOST LIKELY FIRST):\\N   (1) THIS COMPUTER HAS UNRELIABLE MEMORY OR CACHE HARDWARE\\N       (A SURPRISINGLY COMMON PROBLEM; TRY A DIFFERENT MACHINE.)\\N   (2) A BUG IN THE COMPILER USED TO CREATE THIS EXECUTABLE\\N       (UNLIKELY, IF YOU DIDN\'T COMPILE BZIP2 YOURSELF.)\\N   (3) A REAL BUG IN BZIP2 -- I HOPE THIS SHOULD NEVER BE THE CASE.\\N   THE USER\'S MANUAL, SECTION 4.3, HAS MORE INFO ON (1) AND (2).\\N   \\N   IF YOU SUSPECT THIS IS A BUG IN BZIP2, OR ARE UNSURE ABOUT (1)\\N   OR (2), FEEL FREE TO REPORT IT TO ME AT: JSEWARD@BZIP.ORG.\\N   SECTION 4.3 OF THE USER\'S MANUAL DESCRIBES THE INFO A USEFUL\\N   BUG REPORT SHOULD HAVE.  IF THE MANUAL IS AVAILABLE ON YOUR\\N   SYSTEM, PLEASE TRY AND READ IT BEFORE MAILING ME.  IF YOU DON\'T\\N   HAVE THE MANUAL OR CAN\'T BE BOTHERED TO READ IT, MAIL ME ANYWAY.\\N\\N', __CIL_TMP9)
; BabelExp_64 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP10, BabelExp_64, 8),
BabelExp_65 is __CIL_GP_PROGNAME,
babelPtrR(__CIL_TMP11, BabelExp_65, 8),
babel__implicit_mySIGSEGVorSIGBUScatcherc_38(__CIL_TMP10, '\\N%S: CAUGHT A SIGSEGV OR SIGBUS WHILST DECOMPRESSING.\\N\\N   POSSIBLE CAUSES ARE (MOST LIKELY FIRST):\\N   (1) THE COMPRESSED DATA IS CORRUPTED, AND BZIP2\'S USUAL CHECKS\\N       FAILED TO DETECT THIS.  TRY BZIP2 -TVV MY_FILE.BZ2.\\N   (2) THIS COMPUTER HAS UNRELIABLE MEMORY OR CACHE HARDWARE\\N       (A SURPRISINGLY COMMON PROBLEM; TRY A DIFFERENT MACHINE.)\\N   (3) A BUG IN THE COMPILER USED TO CREATE THIS EXECUTABLE\\N       (UNLIKELY, IF YOU DIDN\'T COMPILE BZIP2 YOURSELF.)\\N   (4) A REAL BUG IN BZIP2 -- I HOPE THIS SHOULD NEVER BE THE CASE.\\N   THE USER\'S MANUAL, SECTION 4.3, HAS MORE INFO ON (2) AND (3).\\N   \\N   IF YOU SUSPECT THIS IS A BUG IN BZIP2, OR ARE UNSURE ABOUT (2)\\N   OR (3), FEEL FREE TO REPORT IT TO ME AT: JSEWARD@BZIP.ORG.\\N   SECTION 4.3 OF THE USER\'S MANUAL DESCRIBES THE INFO A USEFUL\\N   BUG REPORT SHOULD HAVE.  IF THE MANUAL IS AVAILABLE ON YOUR\\N   SYSTEM, PLEASE TRY AND READ IT BEFORE MAILING ME.  IF YOU DON\'T\\N   HAVE THE MANUAL OR CAN\'T BE BOTHERED TO READ IT, MAIL ME ANYWAY.\\N\\N', __CIL_TMP11)),
babel__implicit_mySIGSEGVorSIGBUScatcherc_39(0),
BabelExp_66 is __CIL_GP_OPMODE,
babelPtrR(__CIL_TMP12, BabelExp_66, 4),
...
(__CIL_TMP6 \= 0 ->
babel__implicit_mySIGSEGVorSIGBUScatcherc_40(3)
; babel__implicit_mySIGSEGVorSIGBUScatcherc_41(0),
babel__implicit_mySIGSEGVorSIGBUScatcherc_42(2)). 

 :- foreign(babel__implicit_outOfMemoryc_43(+integer, +integer, +integer)).
:- foreign(babel__implicit_outOfMemoryc_44(+integer)).
:- foreign(babel__implicit_outOfMemoryc_45(+integer)).

outOfMemory(__CIL_GP_STDERR, __CIL_GP_PROGNAME, BABEL_RET) :- 


 BabelExp_67 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP3, BabelExp_67, 8),
BabelExp_68 is __CIL_GP_PROGNAME,
babelPtrR(__CIL_TMP4, BabelExp_68, 8),
babel__implicit_outOfMemoryc_43(__CIL_TMP3, '\\N%S: COULDN\'T ALLOCATE ENOUGH MEMORY\\N', __CIL_TMP4),
babel__implicit_outOfMemoryc_44(0),
babel__implicit_outOfMemoryc_45(1). 

 :- foreign(babel__implicit_configErrorc_46(+integer, +integer)).
:- foreign(babel__implicit_configErrorc_47(+integer)).
:- foreign(babel__implicit_configErrorc_48(+integer)).

configError(__CIL_GP_STDERR, __CIL_GP_EXITVALUE, BABEL_RET) :- 


 BabelExp_69 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP3, BabelExp_69, 8),
babel__implicit_configErrorc_46(__CIL_TMP3, 'BZIP2: I\'M NOT CONFIGURED CORRECTLY FOR THIS PLATFORM!\\N\\TI REQUIRE INT32, INT16 AND CHAR TO HAVE SIZES\\N\\TOF 4, 2 AND 1 BYTES TO RUN PROPERLY, AND THEY DON\'T.\\N\\TPROBABLY YOU CAN FIX THIS BY DEFINING THEM CORRECTLY,\\N\\TAND RECOMPILING.  BYE!\\N'),
babel__implicit_configErrorc_47(3),
BabelExp_70 is __CIL_GP_EXITVALUE,
babelPtrR(__CIL_TMP4, BabelExp_70, 4),
babel__implicit_configErrorc_48(__CIL_TMP4). 

 :- foreign(babel__implicit_padc_49(+integer,  -positive)).
:- foreign(babel__implicit_padc_50(+integer, +integer)).

pad(__CIL_GP_LONGESTFILENAME, S, VOID) :- 


 babel__implicit_padc_49(S , TMP_SSA_1),
BabelExp_71 is __CIL_GP_LONGESTFILENAME,
babelPtrR(__CIL_TMP9, BabelExp_71, 4),

(TMP_SSA_1 >= __CIL_TMP9 ->
__CIL_TMP8 is 1
; __CIL_TMP8 is 0),
...
true
; I_SSA_1 is 1,
babel__implicit_padc_50(S, I_SSA_1),true). 

 :- foreign(babel__implicit_copyFileNamec_51(+integer,  -positive)).
:- foreign(babel__implicit_copyFileNamec_52(+integer, +integer, +integer, +integer)).
:- foreign(babel__implicit_copyFileNamec_53(+integer)).
:- foreign(babel__implicit_copyFileNamec_54(+integer)).
:- foreign(babel__implicit_copyFileNamec_55(+integer, +integer, +positive)).

copyFileName(__CIL_GP_STDERR, __CIL_GP_EXITVALUE, TO, FROM, VOID) :- 


 babel__implicit_copyFileNamec_51(FROM , TMP_SSA_1),
...
(__CIL_TMP7 \= 0 ->
BabelExp_72 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP8, BabelExp_72, 8),
babel__implicit_copyFileNamec_52(__CIL_TMP8, 'BZIP2: FILE NAME\\N`%S\'\\NIS SUSPICIOUSLY (MORE THAN %D CHARS) LONG.\\NTRY USING A REASONABLE FILE NAME INSTEAD.  SORRY! :-)\\N', FROM, 1024),
babel__implicit_copyFileNamec_53(1),
BabelExp_73 is __CIL_GP_EXITVALUE,
babelPtrR(__CIL_TMP9, BabelExp_73, 4),
babel__implicit_copyFileNamec_54(__CIL_TMP9)
; true),
babel__implicit_copyFileNamec_55(TO, FROM, 1024),
__CIL_TMP10 is TO +1* 1024,
BabelExp_74 is 0,
babel_ptrE(__CIL_TMP10, BabelExp_74, 1),true. 

 :- foreign(babel__implicit_fileExistsc_56(+integer, +integer,  -integer)).
:- foreign(babel__implicit_fileExistsc_57(+integer)).

fileExists(NAME, BABEL_RET) :- 


 babel__implicit_fileExistsc_56(NAME, 'RB' , TMP___0_SSA_1),
...
(__CIL_TMP8 \= 0 ->
babel__implicit_fileExistsc_57(TMP_SSA_1)
; true),
BABEL_RET is EXISTS_SSA_1, true. 

 :- foreign(babel__implicit_fopen_output_safelyc_58(+integer, +integer, +integer,  -integer)).
:- foreign(babel__implicit_fopen_output_safelyc_59(+integer, +integer,  -integer)).
:- foreign(babel__implicit_fopen_output_safelyc_60(+integer)).

fopen_output_safely(NAME, MODE, BABEL_RET) :- 

babel__implicit_fopen_output_safelyc_58(NAME, 193, 384 , FH_SSA_1),
...
(__CIL_TMP7 \= 0 ->
BABEL_RET is 0, true
; babel__implicit_fopen_output_safelyc_59(FH_SSA_1, MODE , FP_SSA_1),
...
(__CIL_TMP8 \= 0 ->
babel__implicit_fopen_output_safelyc_60(FH_SSA_1)
; true),
BABEL_RET is FP_SSA_1, true),
BABEL_RET is FP_SSA_1, true. 

 :- foreign(babel__implicit_notAStandardFilec_61(+integer, +integer,  -integer)).

notAStandardFile(__CIL_PP_STATBUF, NAME, BABEL_RET) :- 


 babel__implicit_notAStandardFilec_61(NAME, __CIL_PP_STATBUF , I_SSA_1),
...
(__CIL_TMP6 \= 0 ->
BABEL_RET is 1, true
; __CIL_TMP8 is __CIL_PP_STATBUF +1* 24,
__CIL_TMP9 is __CIL_TMP8,
BabelExp_75 is __CIL_TMP9,
babelPtrR(__CIL_TMP10, BabelExp_75, 4),
BabelExp_76 is __CIL_TMP10 /\ 61440,
__CIL_TMP11 is BabelExp_76,
...
; BABEL_RET is 1, true)). 
 ...
 :- foreign(babel__implicit_countHardLinksc_62(+integer, +integer,  -integer)).

countHardLinks(__CIL_PP_STATBUF, NAME, BABEL_RET) :- 


 babel__implicit_countHardLinksc_62(NAME, __CIL_PP_STATBUF , I_SSA_1),
...
(__CIL_TMP6 \= 0 ->
BABEL_RET is 0, true
; __CIL_TMP8 is __CIL_PP_STATBUF +1* 16,
__CIL_TMP9 is __CIL_TMP8,
BabelExp_77 is __CIL_TMP9,
babelPtrR(__CIL_TMP10, BabelExp_77, 8),
BabelExp_78 is __CIL_TMP10 - 1,
__CIL_TMP11 is BabelExp_78,
__CIL_TMP7 is __CIL_TMP11,BABEL_RET is __CIL_TMP7, true). 
...
; true). 
 ...
 :- foreign(babel__implicit_pad_cil_lr_1c_92(+integer,  -positive)).
:- foreign(babel__implicit_pad_cil_lr_1c_93(+integer, +integer)).
:- foreign(babel__implicit_pad_cil_lr_1c_94(+integer, +integer)).

pad_cil_lr_1(__CIL_GP_LONGESTFILENAME, __CIL_GP_STDERR, S, I, VOID) :- 


 babel__implicit_pad_cil_lr_1c_92(S , TMP___0_SSA_1),
BabelExp_115 is __CIL_GP_LONGESTFILENAME,
babelPtrR(__CIL_TMP9, BabelExp_115, 4),
BabelExp_116 is __CIL_TMP9 - TMP___0_SSA_1,
__CIL_TMP10 is BabelExp_116,
...
(__CIL_TMP8 \= 0 ->
BabelExp_117 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP11, BabelExp_117, 8),
babel__implicit_pad_cil_lr_1c_93(__CIL_TMP11, ' '),
BabelExp_118 is I + 1,
I_SSA_1 is BabelExp_118,
babel__implicit_pad_cil_lr_1c_94(S, I_SSA_1),true
; true). 
...
:- foreign(babel__implicit_BZ2_indexIntoFc_0(+integer, +integer, +integer, +integer)).

bZ2_indexIntoF(__CIL_PP_NB, __CIL_FP_NB, INDX, CFTAB, BABEL_RET) :- 


 NB_SSA_1 is 0,
NA_SSA_1 is 256,
BabelExp_0 is NB_SSA_1,
babel_ptrE(__CIL_FP_NB, BabelExp_0, 4),
babel__implicit_BZ2_indexIntoFc_0(__CIL_PP_NB, INDX, CFTAB, NA_SSA_1),
BabelExp_1 is __CIL_FP_NB,
babelPtrR(NB_SSA_2, BabelExp_1, 4),BABEL_RET is NB_SSA_2, true. 

 :- foreign(babel__implicit_myfeof_newc_1(+integer,  -integer)).
:- foreign(babel__implicit_myfeof_newc_2(+integer, +integer)).

myfeof_new(F, BABEL_RET) :- 


 babel__implicit_myfeof_newc_1(F , TMP_SSA_1),
C_SSA_1 is TMP_SSA_1,
...
(__CIL_TMP6 \= 0 ->
BABEL_RET is 1, true
; babel__implicit_myfeof_newc_2(C_SSA_1, F),BABEL_RET is 0, true). 

 :- foreign(babel__implicit_BZ2_bzWriteClosec_3(+integer, +integer, +integer, +integer, +integer, +integer, +integer)).

bZ2_bzWriteClose(BZERROR, B, ABANDON, NBYTES_IN, NBYTES_OUT, VOID) :- 


 babel__implicit_BZ2_bzWriteClosec_3(BZERROR, B, ABANDON, NBYTES_IN, 0, NBYTES_OUT, 0),true. 

 :- foreign(babel__implicit_BZ2_bzopenc_4(+integer, +integer, +integer, +integer,  -integer)).

bZ2_bzopen(PATH, MODE, BABEL_RET) :- 


 babel__implicit_BZ2_bzopenc_4(PATH, -1, MODE, 0 , TMP_SSA_1),BABEL_RET is TMP_SSA_1, true. 

 
prepare_new_block_cil_lr_1(__CIL_AP_S, I, VOID) :- 
...
(__CIL_TMP4 \= 0 ->
BabelExp_2 is __CIL_AP_S,
babelPtrR(__CIL_TMP5, BabelExp_2, 8),
__CIL_TMP6 is __CIL_TMP5,
__CIL_TMP7 is __CIL_TMP6 +1* 128,
__CIL_TMP8 is __CIL_TMP7,
__CIL_TMP9 is __CIL_TMP8,
__CIL_TMP10 is __CIL_TMP9 +1* I,
BabelExp_3 is 0,
babel_ptrE(__CIL_TMP10, BabelExp_3, 1),
BabelExp_4 is I + 1,
I_SSA_1 is BabelExp_4,
prepare_new_block_cil_lr_1(__CIL_AP_S, I_SSA_1, VOID),true
; true). 

 
bz_config_ok(BABEL_RET) :- 
...
; BABEL_RET is 1, true))). 
 ...
 :- foreign(babel__implicit_default_bzallocc_0(+positive,  -integer)).

default_bzalloc(OPAQUE, ITEMS, SIZE, BABEL_RET) :- 


 BabelExp_0 is ITEMS * SIZE,
__CIL_TMP8 is BabelExp_0,
babel__implicit_default_bzallocc_0(__CIL_TMP8 , TMP_SSA_1),
V_SSA_1 is TMP_SSA_1,BABEL_RET is V_SSA_1, true. 

 :- foreign(babel__implicit_default_bzfreec_1(+integer)).
...
(__CIL_TMP3 \= 0 ->
babel__implicit_default_bzfreec_1(ADDR)
; true),
true. 

 :- foreign(babel__implicit_prepare_new_blockc_2(+integer, +integer)).

prepare_new_block(__CIL_PP_S, __CIL_FP_S, S, VOID) :- 


 __CIL_TMP7 is S +1* 108,
__CIL_TMP8 is __CIL_TMP7,
BabelExp_1 is 0,
babel_ptrE(__CIL_TMP8, BabelExp_1, 4),
__CIL_TMP9 is S +1* 116,
__CIL_TMP10 is __CIL_TMP9,
BabelExp_2 is 0,
babel_ptrE(__CIL_TMP10, BabelExp_2, 4),
__CIL_TMP11 is S +1* 120,
__CIL_TMP12 is __CIL_TMP11,
BabelExp_3 is 0,
babel_ptrE(__CIL_TMP12, BabelExp_3, 4),
__CIL_TMP13 is S +1* 648,
__CIL_TMP14 is __CIL_TMP13,
BabelExp_4 is 4294967295,
babel_ptrE(__CIL_TMP14, BabelExp_4, 4),
I_SSA_1 is 0,
BabelExp_5 is S,
babel_ptrE(__CIL_FP_S, BabelExp_5, 8),
babel__implicit_prepare_new_blockc_2(__CIL_PP_S, I_SSA_1),
BabelExp_6 is __CIL_FP_S,
babelPtrR(S_SSA_1, BabelExp_6, 8),
__CIL_TMP15 is S_SSA_1 +1* 660,
__CIL_TMP16 is __CIL_TMP15,
BabelExp_7 is __CIL_TMP16,
babelPtrR(__CIL_TMP17, BabelExp_7, 4),
__CIL_TMP18 is S_SSA_1 +1* 660,
__CIL_TMP19 is __CIL_TMP18,
BabelExp_8 is __CIL_TMP17 + 1,
babel_ptrE(__CIL_TMP19, BabelExp_8, 4),true. 

 
init_RL(S, VOID) :- 


 __CIL_TMP2 is S +1* 92,
__CIL_TMP3 is __CIL_TMP2,
BabelExp_9 is 256,
babel_ptrE(__CIL_TMP3, BabelExp_9, 4),
__CIL_TMP4 is S +1* 96,
__CIL_TMP5 is __CIL_TMP4,
BabelExp_10 is 0,
babel_ptrE(__CIL_TMP5, BabelExp_10, 4),true. 

 
isempty_RL(S, BABEL_RET) :- 


 __CIL_TMP4 is S +1* 92,
__CIL_TMP5 is __CIL_TMP4,
BabelExp_11 is __CIL_TMP5,
babelPtrR(__CIL_TMP6, BabelExp_11, 4),
...
(__CIL_TMP2 \= 0 ->
__CIL_TMP7 is S +1* 96,
__CIL_TMP8 is __CIL_TMP7,
BabelExp_12 is __CIL_TMP8,
babelPtrR(__CIL_TMP9, BabelExp_12, 4),
...
; BABEL_RET is 1, true). 
 ...
 :- foreign(babel__implicit_flush_RLc_3(+integer)).
:- foreign(babel__implicit_flush_RLc_4(+integer)).

flush_RL(S, VOID) :- 


 __CIL_TMP3 is S +1* 92,
__CIL_TMP4 is __CIL_TMP3,
BabelExp_13 is __CIL_TMP4,
babelPtrR(__CIL_TMP5, BabelExp_13, 4),
...
(__CIL_TMP2 \= 0 ->
babel__implicit_flush_RLc_3(S)
; true),
babel__implicit_flush_RLc_4(S),true. 
