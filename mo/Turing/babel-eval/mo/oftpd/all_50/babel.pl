...
true. 
 ...
 :- foreign(babel__implicit_ftp_session_destroyc_6(+integer,  -integer)).
:- foreign(babel__implicit_ftp_session_destroyc_7(+string, +string, +integer, +string)).
:- foreign(babel__implicit_ftp_session_destroyc_8(+integer)).

ftp_session_destroy(F, VOID) :- 


 babel__implicit_ftp_session_destroyc_6(F , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_ftp_session_destroyc_7('invariant(f)', 'ftp_session.c', 286, 'ftp_session_destroy')
; true),
__CIL_TMP5 is F +1* 4280,
__CIL_TMP6 is __CIL_TMP5,
BabelExp_0 is __CIL_TMP6,
babelPtrR(__CIL_TMP7, BabelExp_0, 4),
...
(__CIL_TMP4 \= 0 ->
__CIL_TMP8 is F +1* 4280,
__CIL_TMP9 is __CIL_TMP8,
BabelExp_1 is __CIL_TMP9,
babelPtrR(__CIL_TMP10, BabelExp_1, 4),
babel__implicit_ftp_session_destroyc_8(__CIL_TMP10),
__CIL_TMP11 is F +1* 4280,
__CIL_TMP12 is __CIL_TMP11,
BabelExp_2 is -1,
babel_ptrE(__CIL_TMP12, BabelExp_2, 4)
; true),
true. 
...
true. 
 ...
 :- foreign(babel__implicit_do_passc_21(+integer,  -integer)).
:- foreign(babel__implicit_do_passc_22(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_passc_23(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_passc_24(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_passc_25(+integer, +string, +integer, +integer)).
:- foreign(babel__implicit_do_passc_26(+integer, +integer, +string)).
:- foreign(babel__implicit_do_passc_27(+integer,  -integer)).
:- foreign(babel__implicit_do_passc_28(+string, +string, +integer, +string)).

do_pass(F, CMD, VOID) :- 


 babel__implicit_do_passc_21(F , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_do_passc_22('invariant(f)', 'ftp_session.c', 402, 'do_pass')
; true),
...
(__CIL_TMP10 =:= 0 ->
babel__implicit_do_passc_23('cmd != ((void *)0)', 'ftp_session.c', 403, 'do_pass')
; true),
__CIL_TMP12 is CMD +1* 8,
__CIL_TMP13 is __CIL_TMP12,
BabelExp_4 is __CIL_TMP13,
babelPtrR(__CIL_TMP14, BabelExp_4, 4),
...
(__CIL_TMP11 =:= 0 ->
babel__implicit_do_passc_24('cmd->num_arg == 1', 'ftp_session.c', 404, 'do_pass')
; true),
...
__CIL_TMP20 is __CIL_TMP19,
PASSWORD_SSA_1 is __CIL_TMP20,
__CIL_TMP21 is F +1* 60,
__CIL_TMP22 is __CIL_TMP21,
__CIL_TMP23 is __CIL_TMP22,
babel__implicit_do_passc_25(6, '%s reports e-mail address \'%s\'', __CIL_TMP23, PASSWORD_SSA_1),
babel__implicit_do_passc_26(F, 230, 'User logged in, proceed.'),
babel__implicit_do_passc_27(F , TMP___0_SSA_1),
(TMP___0_SSA_1 =:= 0 ->
babel__implicit_do_passc_28('invariant(f)', 'ftp_session.c', 411, 'do_pass')
; true),
true. 
...
true. 
 ...
 :- foreign(babel__implicit_do_cdupc_36(+integer,  -integer)).
:- foreign(babel__implicit_do_cdupc_37(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_cdupc_38(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_cdupc_39(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_cdupc_40(+integer, +string)).
:- foreign(babel__implicit_do_cdupc_41(+integer,  -integer)).
:- foreign(babel__implicit_do_cdupc_42(+string, +string, +integer, +string)).

do_cdup(F, CMD, VOID) :- 


 babel__implicit_do_cdupc_36(F , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_do_cdupc_37('invariant(f)', 'ftp_session.c', 479, 'do_cdup')
; true),
...
(__CIL_TMP7 =:= 0 ->
babel__implicit_do_cdupc_38('cmd != ((void *)0)', 'ftp_session.c', 480, 'do_cdup')
; true),
__CIL_TMP9 is CMD +1* 8,
__CIL_TMP10 is __CIL_TMP9,
BabelExp_6 is __CIL_TMP10,
babelPtrR(__CIL_TMP11, BabelExp_6, 4),
...
(__CIL_TMP8 =:= 0 ->
babel__implicit_do_cdupc_39('cmd->num_arg == 0', 'ftp_session.c', 481, 'do_cdup')
; true),
babel__implicit_do_cdupc_40(F, '..'),
babel__implicit_do_cdupc_41(F , TMP___0_SSA_1),
(TMP___0_SSA_1 =:= 0 ->
babel__implicit_do_cdupc_42('invariant(f)', 'ftp_session.c', 485, 'do_cdup')
; true),
true. 
...
true. 
 ...
 :- foreign(babel__implicit_do_struc_88(+integer,  -integer)).
:- foreign(babel__implicit_do_struc_89(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_struc_90(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_struc_91(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_struc_92(+integer, +integer, +string)).
:- foreign(babel__implicit_do_struc_93(+integer, +integer, +string)).
:- foreign(babel__implicit_do_struc_94(+integer,  -integer)).
:- foreign(babel__implicit_do_struc_95(+string, +string, +integer, +string)).

do_stru(F, CMD, VOID) :- 


 babel__implicit_do_struc_88(F , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_do_struc_89('invariant(f)', 'ftp_session.c', 990, 'do_stru')
; true),
...
(__CIL_TMP12 =:= 0 ->
babel__implicit_do_struc_90('cmd != ((void *)0)', 'ftp_session.c', 991, 'do_stru')
; true),
__CIL_TMP16 is CMD +1* 8,
__CIL_TMP17 is __CIL_TMP16,
BabelExp_37 is __CIL_TMP17,
babelPtrR(__CIL_TMP18, BabelExp_37, 4),
...
(__CIL_TMP13 =:= 0 ->
babel__implicit_do_struc_91('cmd->num_arg == 1', 'ftp_session.c', 992, 'do_stru')
; true),
__CIL_TMP19 is CMD +1* 16,
__CIL_TMP20 is __CIL_TMP19,
__CIL_TMP21 is __CIL_TMP20,
...
BabelExp_38 is __CIL_TMP25,
babelPtrR_byte(STRUCTURE_SSA_1, BabelExp_38, 1),
CMD_OKAY_SSA_1 is 0,
...
(__CIL_TMP14 \= 0 ->
__CIL_TMP26 is F +1* 20,
__CIL_TMP27 is __CIL_TMP26,
BabelExp_39 is 0,
babel_ptrE(__CIL_TMP27, BabelExp_39, 4),
CMD_OKAY_SSA_2 is 1
; (STRUCTURE_SSA_1 =:= 82 ,
__CIL_TMP15 is 1
; __CIL_TMP15 is 0),
...
(__CIL_TMP15 \= 0 ->
__CIL_TMP28 is F +1* 20,
__CIL_TMP29 is __CIL_TMP28,
BabelExp_40 is 1,
babel_ptrE(__CIL_TMP29, BabelExp_40, 4),
CMD_OKAY_SSA_2 is 1
; CMD_OKAY_SSA_2 is CMD_OKAY_SSA_1)),

(CMD_OKAY_SSA_2 \= 0 ->
babel__implicit_do_struc_92(F, 200, 'Command okay.')
; babel__implicit_do_struc_93(F, 504, 'Command not implemented for that parameter.')),
babel__implicit_do_struc_94(F , TMP___0_SSA_1),
(TMP___0_SSA_1 =:= 0 ->
babel__implicit_do_struc_95('invariant(f)', 'ftp_session.c', 1010, 'do_stru')
; true),
true. 
...
true. 
 ...
 :- foreign(babel__implicit_do_storc_116(+integer,  -integer)).
:- foreign(babel__implicit_do_storc_117(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_storc_118(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_storc_119(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_storc_120(+integer, +integer, +string)).
:- foreign(babel__implicit_do_storc_121(+integer,  -integer)).
:- foreign(babel__implicit_do_storc_122(+string, +string, +integer, +string)).

do_stor(F, CMD, VOID) :- 


 babel__implicit_do_storc_116(F , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_do_storc_117('invariant(f)', 'ftp_session.c', 1269, 'do_stor')
; true),
...
(__CIL_TMP7 =:= 0 ->
babel__implicit_do_storc_118('cmd != ((void *)0)', 'ftp_session.c', 1270, 'do_stor')
; true),
__CIL_TMP9 is CMD +1* 8,
__CIL_TMP10 is __CIL_TMP9,
BabelExp_47 is __CIL_TMP10,
babelPtrR(__CIL_TMP11, BabelExp_47, 4),
...
(__CIL_TMP8 =:= 0 ->
babel__implicit_do_storc_119('cmd->num_arg == 1', 'ftp_session.c', 1271, 'do_stor')
; true),
babel__implicit_do_storc_120(F, 553, 'Server will not store files.'),
babel__implicit_do_storc_121(F , TMP___0_SSA_1),
(TMP___0_SSA_1 =:= 0 ->
babel__implicit_do_storc_122('invariant(f)', 'ftp_session.c', 1275, 'do_stor')
; true),
true. 

 :- foreign(babel__implicit_open_connectionc_123(+string, +string, +integer, +string)).
:- foreign(babel__implicit_open_connectionc_124(+integer, +integer, +integer,  -integer)).
:- foreign(babel__implicit_open_connectionc_125( -integer)).
:- foreign(babel__implicit_open_connectionc_126(+integer,  -integer)).
:- foreign(babel__implicit_open_connectionc_127(+integer, +integer, +string, +integer)).
:- foreign(babel__implicit_open_connectionc_128(+integer, +integer, +positive,  -integer)).
:- foreign(babel__implicit_open_connectionc_129( -integer)).
:- foreign(babel__implicit_open_connectionc_130(+integer,  -integer)).
:- foreign(babel__implicit_open_connectionc_131(+integer, +integer, +string, +integer)).
:- foreign(babel__implicit_open_connectionc_132(+integer)).
:- foreign(babel__implicit_open_connectionc_133(+string, +string, +integer, +string)).
:- foreign(babel__implicit_open_connectionc_134(+integer, +integer, +integer,  -integer)).
:- foreign(babel__implicit_open_connectionc_135( -integer)).
:- foreign(babel__implicit_open_connectionc_136(+integer,  -integer)).
:- foreign(babel__implicit_open_connectionc_137(+integer, +integer, +string, +integer)).
:- foreign(babel__implicit_open_connectionc_138(+integer, +integer, +integer,  -integer)).
:- foreign(babel__implicit_open_connectionc_139(+integer, +integer, +string)).
:- foreign(babel__implicit_open_connectionc_140(+integer)).

open_connection(__CIL_PP_ADDR, __CIL_PP_ADDR_LEN, __CIL_FP_ADDR_LEN, F, BABEL_RET) :- 


 __CIL_TMP33 is F +1* 4260,
__CIL_TMP34 is __CIL_TMP33,
BabelExp_48 is __CIL_TMP34,
babelPtrR(__CIL_TMP35, BabelExp_48, 4),
...
(__CIL_TMP26 =:= 0 ->
__CIL_TMP36 is F +1* 4260,
__CIL_TMP37 is __CIL_TMP36,
BabelExp_49 is __CIL_TMP37,
babelPtrR(__CIL_TMP38, BabelExp_49, 4),
...
(__CIL_TMP27 =:= 0 ->
babel__implicit_open_connectionc_123('(f->data_channel == 0) || (f->data_channel == 1)', 'ftp_session.c', 1285, 'open_connection')
; true)
; true),
__CIL_TMP39 is F +1* 4260,
__CIL_TMP40 is __CIL_TMP39,
BabelExp_50 is __CIL_TMP40,
babelPtrR(__CIL_TMP41, BabelExp_50, 4),
...
(__CIL_TMP28 \= 0 ->
__CIL_TMP42 is F +1* 4264,
__CIL_TMP43 is __CIL_TMP42,
__CIL_TMP44 is __CIL_TMP43,
BabelExp_51 is __CIL_TMP44,
babelPtrR(__CIL_TMP45, BabelExp_51, 2),
babel__implicit_open_connectionc_124(__CIL_TMP45, 1, 0 , SOCKET_FD_SSA_1),
...
(__CIL_TMP29 \= 0 ->
babel__implicit_open_connectionc_125(TMP_SSA_1),
BabelExp_52 is TMP_SSA_1,
babelPtrR(__CIL_TMP46, BabelExp_52, 4),
babel__implicit_open_connectionc_126(__CIL_TMP46 , TMP___0_SSA_1),
babel__implicit_open_connectionc_127(F, 425, 'Error creating socket; %s.', TMP___0_SSA_1),BABEL_RET is -1, true
; __CIL_TMP47 is F +1* 4264,
__CIL_TMP48 is __CIL_TMP47,
babel__implicit_open_connectionc_128(SOCKET_FD_SSA_1, __CIL_TMP48, 16 , TMP___3_SSA_1),
...
(__CIL_TMP30 \= 0 ->
babel__implicit_open_connectionc_129(TMP___1_SSA_1),
BabelExp_53 is TMP___1_SSA_1,
babelPtrR(__CIL_TMP49, BabelExp_53, 4),
babel__implicit_open_connectionc_130(__CIL_TMP49 , TMP___2_SSA_1),
babel__implicit_open_connectionc_131(F, 425, 'Error connecting; %s.', TMP___2_SSA_1),
babel__implicit_open_connectionc_132(SOCKET_FD_SSA_1),BABEL_RET is -1, true
; BABEL_RET is SOCKET_FD_SSA_1, true))
; __CIL_TMP50 is F +1* 4260,
__CIL_TMP51 is __CIL_TMP50,
BabelExp_54 is __CIL_TMP51,
babelPtrR(__CIL_TMP52, BabelExp_54, 4),
...
(__CIL_TMP31 =:= 0 ->
babel__implicit_open_connectionc_133('f->data_channel == 1', 'ftp_session.c', 1301, 'open_connection')
; true),
BabelExp_55 is 16,
ADDR_LEN_SSA_1 is BabelExp_55,
BabelExp_56 is ADDR_LEN_SSA_1,
babel_ptrE(__CIL_FP_ADDR_LEN, BabelExp_56, 4),
__CIL_TMP53 is F +1* 4280,
__CIL_TMP54 is __CIL_TMP53,
BabelExp_57 is __CIL_TMP54,
babelPtrR(__CIL_TMP55, BabelExp_57, 4),
babel__implicit_open_connectionc_134(__CIL_TMP55, __CIL_PP_ADDR, __CIL_PP_ADDR_LEN , SOCKET_FD_SSA_1),
...
(__CIL_TMP32 \= 0 ->
babel__implicit_open_connectionc_135(TMP___4_SSA_1),
BabelExp_58 is TMP___4_SSA_1,
babelPtrR(__CIL_TMP56, BabelExp_58, 4),
babel__implicit_open_connectionc_136(__CIL_TMP56 , TMP___5_SSA_1),
babel__implicit_open_connectionc_137(F, 425, 'Error accepting connection; %s.', TMP___5_SSA_1),BABEL_RET is -1, true
; __CIL_TMP57 is F +1* 48,
__CIL_TMP58 is __CIL_PP_ADDR +1* 4,
babel__implicit_open_connectionc_138(__CIL_TMP57, __CIL_TMP58, 4 , TMP___6_SSA_1),
(TMP___6_SSA_1 \= 0 ->
babel__implicit_open_connectionc_139(F, 425, 'Error accepting connection; connection from invalid IP.'),
babel__implicit_open_connectionc_140(SOCKET_FD_SSA_1),BABEL_RET is -1, true
; BABEL_RET is SOCKET_FD_SSA_1, true))). 
...
; BABEL_RET is AMT_WRITTEN_SSA_2, true). 
 ...
 :- foreign(babel__implicit_do_pwdc_145(+integer,  -integer)).
:- foreign(babel__implicit_do_pwdc_146(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_pwdc_147(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_pwdc_148(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_pwdc_149(+integer, +integer, +string, +integer)).
:- foreign(babel__implicit_do_pwdc_150(+integer,  -integer)).
:- foreign(babel__implicit_do_pwdc_151(+string, +string, +integer, +string)).

do_pwd(F, CMD, VOID) :- 


 babel__implicit_do_pwdc_145(F , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_do_pwdc_146('invariant(f)', 'ftp_session.c', 1376, 'do_pwd')
; true),
...
(__CIL_TMP7 =:= 0 ->
babel__implicit_do_pwdc_147('cmd != ((void *)0)', 'ftp_session.c', 1377, 'do_pwd')
; true),
__CIL_TMP9 is CMD +1* 8,
__CIL_TMP10 is __CIL_TMP9,
BabelExp_65 is __CIL_TMP10,
babelPtrR(__CIL_TMP11, BabelExp_65, 4),
...
(__CIL_TMP8 =:= 0 ->
babel__implicit_do_pwdc_148('cmd->num_arg == 0', 'ftp_session.c', 1378, 'do_pwd')
; true),
__CIL_TMP12 is F +1* 160,
__CIL_TMP13 is __CIL_TMP12,
__CIL_TMP14 is __CIL_TMP13,
babel__implicit_do_pwdc_149(F, 257, '\'%s\' is current directory.', __CIL_TMP14),
babel__implicit_do_pwdc_150(F , TMP___0_SSA_1),
(TMP___0_SSA_1 =:= 0 ->
babel__implicit_do_pwdc_151('invariant(f)', 'ftp_session.c', 1382, 'do_pwd')
; true),
true. 
...
true. 
 ...
 :- foreign(babel__implicit_do_noopc_164(+integer,  -integer)).
:- foreign(babel__implicit_do_noopc_165(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_noopc_166(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_noopc_167(+string, +string, +integer, +string)).
:- foreign(babel__implicit_do_noopc_168(+integer, +integer, +string)).
:- foreign(babel__implicit_do_noopc_169(+integer,  -integer)).
:- foreign(babel__implicit_do_noopc_170(+string, +string, +integer, +string)).

do_noop(F, CMD, VOID) :- 


 babel__implicit_do_noopc_164(F , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_do_noopc_165('invariant(f)', 'ftp_session.c', 1588, 'do_noop')
; true),
...
(__CIL_TMP7 =:= 0 ->
babel__implicit_do_noopc_166('cmd != ((void *)0)', 'ftp_session.c', 1589, 'do_noop')
; true),
__CIL_TMP9 is CMD +1* 8,
__CIL_TMP10 is __CIL_TMP9,
BabelExp_67 is __CIL_TMP10,
...
(__CIL_TMP8 =:= 0 ->
babel__implicit_do_noopc_167('cmd->num_arg == 0', 'ftp_session.c', 1590, 'do_noop')
; true),
babel__implicit_do_noopc_168(F, 200, 'Command okay.'),
babel__implicit_do_noopc_169(F , TMP___0_SSA_1),
(TMP___0_SSA_1 =:= 0 ->
babel__implicit_do_noopc_170('invariant(f)', 'ftp_session.c', 1594, 'do_noop')
; true),
true. 
...
:- foreign(babel__implicit_telnet_session_printlnc_0(+integer,  -integer)).
:- foreign(babel__implicit_telnet_session_printlnc_1(+string, +string, +integer, +string)).
:- foreign(babel__implicit_telnet_session_printlnc_2(+integer, +integer,  -integer)).
:- foreign(babel__implicit_telnet_session_printlnc_3(+integer, +string,  -integer)).
:- foreign(babel__implicit_telnet_session_printlnc_4(+integer,  -integer)).
:- foreign(babel__implicit_telnet_session_printlnc_5(+string, +string, +integer, +string)).
:- foreign(babel__implicit_telnet_session_printlnc_6(+integer,  -integer)).
:- foreign(babel__implicit_telnet_session_printlnc_7(+string, +string, +integer, +string)).
:- foreign(babel__implicit_telnet_session_printlnc_8(+integer,  -integer)).
:- foreign(babel__implicit_telnet_session_printlnc_9(+string, +string, +integer, +string)).

telnet_session_println(T, S, BABEL_RET) :- 


 babel__implicit_telnet_session_printlnc_0(T , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_telnet_session_printlnc_1('invariant(t)', 'telnet_session.c', 133, 'telnet_session_println')
; true),
babel__implicit_telnet_session_printlnc_2(T, S , TMP___1_SSA_1),
(TMP___1_SSA_1 \= 0 ->
babel__implicit_telnet_session_printlnc_3(T, '\r\n' , TMP___3_SSA_1),
(TMP___3_SSA_1 \= 0 ->
babel__implicit_telnet_session_printlnc_4(T , TMP___4_SSA_1),
(TMP___4_SSA_1 =:= 0 ->
babel__implicit_telnet_session_printlnc_5('invariant(t)', 'telnet_session.c', 142, 'telnet_session_println')
; true),
BABEL_RET is 1, true
; babel__implicit_telnet_session_printlnc_6(T , TMP___2_SSA_1),
(TMP___2_SSA_1 =:= 0 ->
babel__implicit_telnet_session_printlnc_7('invariant(t)', 'telnet_session.c', 139, 'telnet_session_println')
; true),
BABEL_RET is 0, true),
BABEL_RET is 1, true
; babel__implicit_telnet_session_printlnc_8(T , TMP___0_SSA_1),
(TMP___0_SSA_1 =:= 0 ->
babel__implicit_telnet_session_printlnc_9('invariant(t)', 'telnet_session.c', 135, 'telnet_session_println')
; true),
BABEL_RET is 0, true),
BABEL_RET is 1, true. 
...
:- foreign(babel__implicit_is_valid_dirc_0(+integer,  -positive)).

is_valid_dir(DIR, BABEL_RET) :- 
...
(__CIL_TMP4 \= 0 ->
BABEL_RET is 0, true
; __CIL_TMP7 is DIR +1* 0,
BabelExp_0 is __CIL_TMP7,
babelPtrR_byte(__CIL_TMP8, BabelExp_0, 1),
__CIL_TMP9 is __CIL_TMP8,
...
(__CIL_TMP5 \= 0 ->
BABEL_RET is 0, true
; babel__implicit_is_valid_dirc_0(DIR , TMP_SSA_1),
...
; BABEL_RET is 1, true))). 
 ...
 :- foreign(babel__implicit_skip_ls_optionsc_1(+string, +string, +integer, +string)).
:- foreign(babel__implicit_skip_ls_optionsc_2(+integer)).
:- foreign(babel__implicit_skip_ls_optionsc_3(+string, +string, +integer, +string)).

skip_ls_options(__CIL_PP_FILESPEC, __CIL_FP_FILESPEC, FILESPEC, BABEL_RET) :- 
...
(__CIL_TMP8 =:= 0 ->
babel__implicit_skip_ls_optionsc_1('filespec != ((void *)0)', 'file_list.c', 402, 'skip_ls_options')
; true),
BabelExp_1 is FILESPEC,
babel_ptrE(__CIL_FP_FILESPEC, BabelExp_1, 8),
babel__implicit_skip_ls_optionsc_2(__CIL_PP_FILESPEC),
BabelExp_2 is __CIL_FP_FILESPEC,
babelPtrR(FILESPEC_SSA_1, BabelExp_2, 8),
...
(__CIL_TMP9 =:= 0 ->
babel__implicit_skip_ls_optionsc_3('filespec != ((void *)0)', 'file_list.c', 431, 'skip_ls_options')
; true),
BABEL_RET is FILESPEC_SSA_1, true. 

 :- foreign(babel__implicit_skip_ls_options_cil_lr_1_cil_lr_1c_4( -integer)).

skip_ls_options_cil_lr_1_cil_lr_1(__CIL_AP_FILESPEC, VOID) :- 


 babel__implicit_skip_ls_options_cil_lr_1_cil_lr_1c_4(TMP_SSA_1),
BabelExp_3 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP5, BabelExp_3, 8),
BabelExp_4 is __CIL_TMP5,
babelPtrR_byte(__CIL_TMP6, BabelExp_4, 1),
BabelExp_5 is TMP_SSA_1,
babelPtrR(__CIL_TMP7, BabelExp_5, 8),
__CIL_TMP8 is __CIL_TMP6,
__CIL_TMP9 is __CIL_TMP7 +2* __CIL_TMP8,
BabelExp_6 is __CIL_TMP9,
babelPtrR(__CIL_TMP10, BabelExp_6, 2),
__CIL_TMP11 is __CIL_TMP10,
BabelExp_7 is __CIL_TMP11 /\ 8192,
__CIL_TMP4 is BabelExp_7,
(__CIL_TMP4 \= 0 ->
BabelExp_8 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP12, BabelExp_8, 8),
BabelExp_9 is __CIL_TMP12 +1* 1,
babel_ptrE(__CIL_AP_FILESPEC, BabelExp_9, 8),
skip_ls_options_cil_lr_1_cil_lr_1(__CIL_AP_FILESPEC, VOID),true
; true). 

 :- foreign(babel__implicit_skip_ls_options_cil_lr_1_cil_lr_2c_6( -integer)).

skip_ls_options_cil_lr_1_cil_lr_2(__CIL_AP_FILESPEC, VOID) :- 


 BabelExp_10 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP6, BabelExp_10, 8),
BabelExp_11 is __CIL_TMP6,
babelPtrR_byte(__CIL_TMP7, BabelExp_11, 1),
__CIL_TMP8 is __CIL_TMP7,
...
(__CIL_TMP4 \= 0 ->
babel__implicit_skip_ls_options_cil_lr_1_cil_lr_2c_6(TMP___0_SSA_1),
BabelExp_12 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP9, BabelExp_12, 8),
BabelExp_13 is __CIL_TMP9,
babelPtrR_byte(__CIL_TMP10, BabelExp_13, 1),
BabelExp_14 is TMP___0_SSA_1,
babelPtrR(__CIL_TMP11, BabelExp_14, 8),
__CIL_TMP12 is __CIL_TMP10,
__CIL_TMP13 is __CIL_TMP11 +2* __CIL_TMP12,
BabelExp_15 is __CIL_TMP13,
babelPtrR(__CIL_TMP14, BabelExp_15, 2),
__CIL_TMP15 is __CIL_TMP14,
BabelExp_16 is __CIL_TMP15 /\ 8192,
__CIL_TMP5 is BabelExp_16,
(__CIL_TMP5 \= 0 ->
true
; BabelExp_17 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP16, BabelExp_17, 8),
BabelExp_18 is __CIL_TMP16 +1* 1,
babel_ptrE(__CIL_AP_FILESPEC, BabelExp_18, 8),
skip_ls_options_cil_lr_1_cil_lr_2(__CIL_AP_FILESPEC, VOID),true)
; true). 

 :- foreign(babel__implicit_skip_ls_options_cil_lr_1_cil_lr_3c_8( -integer)).

skip_ls_options_cil_lr_1_cil_lr_3(__CIL_AP_FILESPEC, VOID) :- 


 babel__implicit_skip_ls_options_cil_lr_1_cil_lr_3c_8(TMP___1_SSA_1),
BabelExp_19 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP5, BabelExp_19, 8),
BabelExp_20 is __CIL_TMP5,
babelPtrR_byte(__CIL_TMP6, BabelExp_20, 1),
BabelExp_21 is TMP___1_SSA_1,
babelPtrR(__CIL_TMP7, BabelExp_21, 8),
__CIL_TMP8 is __CIL_TMP6,
__CIL_TMP9 is __CIL_TMP7 +2* __CIL_TMP8,
BabelExp_22 is __CIL_TMP9,
babelPtrR(__CIL_TMP10, BabelExp_22, 2),
__CIL_TMP11 is __CIL_TMP10,
BabelExp_23 is __CIL_TMP11 /\ 8192,
__CIL_TMP4 is BabelExp_23,
(__CIL_TMP4 \= 0 ->
BabelExp_24 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP12, BabelExp_24, 8),
BabelExp_25 is __CIL_TMP12 +1* 1,
babel_ptrE(__CIL_AP_FILESPEC, BabelExp_25, 8),
skip_ls_options_cil_lr_1_cil_lr_3(__CIL_AP_FILESPEC, VOID),true
; true). 

 :- foreign(babel__implicit_skip_ls_options_cil_lr_1c_10(+integer)).
:- foreign(babel__implicit_skip_ls_options_cil_lr_1c_11(+integer)).
:- foreign(babel__implicit_skip_ls_options_cil_lr_1c_12(+integer)).
:- foreign(babel__implicit_skip_ls_options_cil_lr_1c_14(+integer)).
:- foreign(babel__implicit_skip_ls_options_cil_lr_1c_15(+integer)).

skip_ls_options_cil_lr_1(__CIL_AP_FILESPEC, VOID) :- 


 BabelExp_26 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP8, BabelExp_26, 8),
BabelExp_27 is __CIL_TMP8,
babelPtrR_byte(__CIL_TMP9, BabelExp_27, 1),
__CIL_TMP10 is __CIL_TMP9,
...
(__CIL_TMP5 \= 0 ->
true
; BabelExp_28 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP11, BabelExp_28, 8),
BabelExp_29 is __CIL_TMP11 +1* 1,
babel_ptrE(__CIL_AP_FILESPEC, BabelExp_29, 8),
BabelExp_30 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP12, BabelExp_30, 8),
__CIL_TMP13 is __CIL_TMP12 +1* 0,
BabelExp_31 is __CIL_TMP13,
babelPtrR_byte(__CIL_TMP14, BabelExp_31, 1),
__CIL_TMP15 is __CIL_TMP14,
...
(__CIL_TMP6 \= 0 ->
BabelExp_32 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP16, BabelExp_32, 8),
__CIL_TMP17 is __CIL_TMP16 +1* 1,
BabelExp_33 is __CIL_TMP17,
babelPtrR_byte(__CIL_TMP18, BabelExp_33, 1),
__CIL_TMP19 is __CIL_TMP18,
...
(__CIL_TMP7 \= 0 ->
BabelExp_34 is __CIL_AP_FILESPEC,
babelPtrR(__CIL_TMP20, BabelExp_34, 8),
BabelExp_35 is __CIL_TMP20 +1* 2,
babel_ptrE(__CIL_AP_FILESPEC, BabelExp_35, 8),
babel__implicit_skip_ls_options_cil_lr_1c_10(__CIL_AP_FILESPEC),true
; babel__implicit_skip_ls_options_cil_lr_1c_11(__CIL_AP_FILESPEC),
babel__implicit_skip_ls_options_cil_lr_1c_12(__CIL_AP_FILESPEC),
skip_ls_options_cil_lr_1(__CIL_AP_FILESPEC, VOID),true)
; babel__implicit_skip_ls_options_cil_lr_1c_14(__CIL_AP_FILESPEC),
babel__implicit_skip_ls_options_cil_lr_1c_15(__CIL_AP_FILESPEC),
skip_ls_options_cil_lr_1(__CIL_AP_FILESPEC, VOID),true)). 

 

:- foreign(babel__implicit_error_get_error_codec_0(+integer,  -integer)).
:- foreign(babel__implicit_error_get_error_codec_1(+string, +string, +integer, +string)).

error_get_error_code(ERR, BABEL_RET) :- 


 babel__implicit_error_get_error_codec_0(ERR , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_error_get_error_codec_1('invariant(err)', 'error.c', 40, 'error_get_error_code')
; true),
MEM_5 is ERR,
BabelExp_0 is MEM_5,
babelPtrR(__CIL_TMP5, BabelExp_0, 4),
__CIL_TMP4 is __CIL_TMP5,BABEL_RET is __CIL_TMP4, true. 

 :- foreign(babel__implicit_error_get_descc_2(+integer,  -integer)).
:- foreign(babel__implicit_error_get_descc_3(+string, +string, +integer, +string)).

error_get_desc(ERR, BABEL_RET) :- 


 babel__implicit_error_get_descc_2(ERR , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_error_get_descc_3('invariant(err)', 'error.c', 46, 'error_get_desc')
; true),
__CIL_TMP5 is ERR +1* 4,
__CIL_TMP6 is __CIL_TMP5,
__CIL_TMP7 is __CIL_TMP6,
__CIL_TMP4 is __CIL_TMP7,BABEL_RET is __CIL_TMP4, true. 

 :- foreign(babel__implicit_invariantc_4(+integer,  -positive)).

invariant(ERR, BABEL_RET) :- 
...
BABEL_RET is 0, true
; MEM_10 is ERR,
BabelExp_1 is MEM_10,
babelPtrR(__CIL_TMP7, BabelExp_1, 4),
...
(__CIL_TMP5 \= 0 ->
BABEL_RET is 0, true
; __CIL_TMP8 is ERR +1* 4,
__CIL_TMP9 is __CIL_TMP8,
__CIL_TMP10 is __CIL_TMP9,
babel__implicit_invariantc_4(__CIL_TMP10 , TMP_SSA_1),
MEM_11 is ERR +1* 4,
...
:- foreign(babel__implicit_copy_stringc_0(+string, +string, +integer, +string)).
:- foreign(babel__implicit_copy_stringc_1(+string, +string, +integer, +string)).
:- foreign(babel__implicit_copy_stringc_2(+integer, +integer, +integer)).

copy_string(__CIL_PP_DST, __CIL_PP_SRC, __CIL_PP_I, __CIL_FP_DST, __CIL_FP_SRC, __CIL_FP_I, DST, SRC, BABEL_RET) :- 
...
(__CIL_TMP14 =:= 0 ->
babel__implicit_copy_stringc_0('dst != ((void *)0)', 'ftp_command.c', 307, 'copy_string')
; true),
...
(__CIL_TMP15 =:= 0 ->
babel__implicit_copy_stringc_1('src != ((void *)0)', 'ftp_command.c', 308, 'copy_string')
; true),
I_SSA_1 is 0,
BabelExp_0 is DST,
babel_ptrE(__CIL_FP_DST, BabelExp_0, 8),
BabelExp_1 is SRC,
babel_ptrE(__CIL_FP_SRC, BabelExp_1, 8),
BabelExp_2 is I_SSA_1,
babel_ptrE(__CIL_FP_I, BabelExp_2, 4),
babel__implicit_copy_stringc_2(__CIL_PP_DST, __CIL_PP_SRC, __CIL_PP_I),
BabelExp_3 is __CIL_FP_DST,
babelPtrR(DST_SSA_1, BabelExp_3, 8),
BabelExp_4 is __CIL_FP_SRC,
babelPtrR(SRC_SSA_1, BabelExp_4, 8),
BabelExp_5 is __CIL_FP_I,
babelPtrR(I_SSA_2, BabelExp_5, 4),
__CIL_TMP17 is DST_SSA_1 +1* I_SSA_2,
BabelExp_6 is 0,
babel_ptrE(__CIL_TMP17, BabelExp_6, 1),
__CIL_TMP16 is SRC_SSA_1 +1* I_SSA_2,BABEL_RET is __CIL_TMP16, true. 

 :- foreign(babel__implicit_parse_numberc_3(+string, +string, +integer, +string)).
:- foreign(babel__implicit_parse_numberc_4(+string, +string, +integer, +string)).
:- foreign(babel__implicit_parse_numberc_5( -integer)).
:- foreign(babel__implicit_parse_numberc_6(+integer, +integer, +integer, +integer, +integer,  -integer)).
:- foreign(babel__implicit_parse_numberc_7(+string, +string, +integer, +string)).
:- foreign(babel__implicit_parse_numberc_8(+string, +string, +integer, +string)).
:- foreign(babel__implicit_parse_numberc_9(+string, +string, +integer, +string)).
:- foreign(babel__implicit_parse_numberc_10(+string, +string, +integer, +string)).

parse_number(__CIL_PP_NUM, __CIL_PP_S, __CIL_PP_MAX_NUM, __CIL_PP_TMP, __CIL_PP___CIL_RET8, __CIL_FP_NUM, __CIL_FP_S, __CIL_FP_MAX_NUM, __CIL_FP_TMP, __CIL_FP___CIL_RET8, NUM, S, MAX_NUM, BABEL_RET) :- 
...
(__CIL_TMP29 =:= 0 ->
babel__implicit_parse_numberc_3('s != ((void *)0)', 'ftp_command.c', 584, 'parse_number')
; true),
...
(__CIL_TMP30 =:= 0 ->
babel__implicit_parse_numberc_4('num != ((void *)0)', 'ftp_command.c', 585, 'parse_number')
; true),
babel__implicit_parse_numberc_5(TMP___0_SSA_1),
BabelExp_7 is S,
babelPtrR_byte(__CIL_TMP36, BabelExp_7, 1),
BabelExp_8 is TMP___0_SSA_1,
babelPtrR(__CIL_TMP37, BabelExp_8, 8),
__CIL_TMP38 is __CIL_TMP36,
__CIL_TMP39 is __CIL_TMP37 +2* __CIL_TMP38,
BabelExp_9 is __CIL_TMP39,
babelPtrR(__CIL_TMP40, BabelExp_9, 2),
__CIL_TMP41 is __CIL_TMP40,
BabelExp_10 is __CIL_TMP41 /\ 2048,
__CIL_TMP31 is BabelExp_10,
(__CIL_TMP31 \= 0 ->
BabelExp_11 is S,
babelPtrR_byte(__CIL_TMP42, BabelExp_11, 1),
__CIL_TMP43 is __CIL_TMP42,
BabelExp_12 is __CIL_TMP43 - 48,
__CIL_TMP44 is BabelExp_12,
TMP_SSA_1 is __CIL_TMP44,
S_SSA_1 is S +1* 1,
BabelExp_13 is NUM,
babel_ptrE(__CIL_FP_NUM, BabelExp_13, 8),
BabelExp_14 is S_SSA_1,
babel_ptrE(__CIL_FP_S, BabelExp_14, 8),
BabelExp_15 is MAX_NUM,
babel_ptrE(__CIL_FP_MAX_NUM, BabelExp_15, 4),
BabelExp_16 is TMP_SSA_1,
babel_ptrE(__CIL_FP_TMP, BabelExp_16, 4),
__CIL_RET8 is 1,
BabelExp_17 is __CIL_RET8,
babel_ptrE(__CIL_FP___CIL_RET8, BabelExp_17, 8),
babel__implicit_parse_numberc_6(__CIL_PP_NUM, __CIL_PP_S, __CIL_PP_MAX_NUM, __CIL_PP_TMP, __CIL_PP___CIL_RET8 , RETFLAG9_SSA_1),
BabelExp_18 is __CIL_FP_NUM,
babelPtrR(NUM_SSA_1, BabelExp_18, 8),
BabelExp_19 is __CIL_FP_S,
babelPtrR(S_SSA_2, BabelExp_19, 8),
BabelExp_20 is __CIL_FP_MAX_NUM,
babelPtrR(MAX_NUM_SSA_1, BabelExp_20, 4),
BabelExp_21 is __CIL_FP_TMP,
babelPtrR(TMP_SSA_2, BabelExp_21, 4),
BabelExp_22 is __CIL_FP___CIL_RET8,
babelPtrR(__CIL_RET8_SSA_1, BabelExp_22, 8),
(RETFLAG9_SSA_1 \= 0 ->
BABEL_RET is __CIL_RET8_SSA_1, true
; (TMP_SSA_2 >= 0 ,
__CIL_TMP32 is 1
; __CIL_TMP32 is 0),

(__CIL_TMP32 =:= 0 ->
babel__implicit_parse_numberc_7('tmp >= 0', 'ftp_command.c', 608, 'parse_number')
; true),

(TMP_SSA_2 =< MAX_NUM_SSA_1 ,
__CIL_TMP33 is 1
; __CIL_TMP33 is 0),

(__CIL_TMP33 =:= 0 ->
babel__implicit_parse_numberc_8('tmp <= max_num', 'ftp_command.c', 609, 'parse_number')
; true),
BabelExp_23 is TMP_SSA_2,
babel_ptrE(NUM_SSA_1, BabelExp_23, 4),BABEL_RET is S_SSA_2, true),
...
(__CIL_TMP34 =:= 0 ->
babel__implicit_parse_numberc_9('tmp <= max_num', 'ftp_command.c', 609, 'parse_number')
; true),
BabelExp_24 is TMP,
babel_ptrE(NUM, BabelExp_24, 4),BABEL_RET is S, true
; BABEL_RET is 0, true),
...
(__CIL_TMP35 =:= 0 ->
babel__implicit_parse_numberc_10('tmp <= max_num', 'ftp_command.c', 609, 'parse_number')
; true),
BabelExp_25 is TMP,
babel_ptrE(NUM, BabelExp_25, 4),BABEL_RET is S, true. 

 :- foreign(babel__implicit_parse_number_cil_lr_1c_11( -integer)).

parse_number_cil_lr_1(__CIL_AP_NUM, __CIL_AP_S, __CIL_AP_MAX_NUM, __CIL_AP_TMP, __CIL_AP___CIL_RET8, BABEL_RET) :- 


 babel__implicit_parse_number_cil_lr_1c_11(TMP___1_SSA_1),
BabelExp_26 is __CIL_AP_S,
babelPtrR(__CIL_TMP14, BabelExp_26, 8),
BabelExp_27 is __CIL_TMP14,
babelPtrR_byte(__CIL_TMP15, BabelExp_27, 1),
BabelExp_28 is TMP___1_SSA_1,
babelPtrR(__CIL_TMP16, BabelExp_28, 8),
__CIL_TMP17 is __CIL_TMP15,
__CIL_TMP18 is __CIL_TMP16 +2* __CIL_TMP17,
BabelExp_29 is __CIL_TMP18,
babelPtrR(__CIL_TMP19, BabelExp_29, 2),
__CIL_TMP20 is __CIL_TMP19,
BabelExp_30 is __CIL_TMP20 /\ 2048,
__CIL_TMP12 is BabelExp_30,
(__CIL_TMP12 \= 0 ->
BabelExp_31 is __CIL_AP_S,
babelPtrR(__CIL_TMP21, BabelExp_31, 8),
BabelExp_32 is __CIL_TMP21,
babelPtrR_byte(__CIL_TMP22, BabelExp_32, 1),
__CIL_TMP23 is __CIL_TMP22,
BabelExp_33 is __CIL_TMP23 - 48,
__CIL_TMP24 is BabelExp_33,
CUR_DIGIT_SSA_1 is __CIL_TMP24,
BabelExp_34 is __CIL_AP_MAX_NUM,
babelPtrR(__CIL_TMP25, BabelExp_34, 4),
BabelExp_35 is __CIL_AP_TMP,
babelPtrR(__CIL_TMP26, BabelExp_35, 4),
BabelExp_36 is __CIL_TMP25 - CUR_DIGIT_SSA_1,
__CIL_TMP27 is BabelExp_36,
BabelExp_37 is __CIL_TMP26 * 10,
__CIL_TMP28 is BabelExp_37,
...
(__CIL_TMP13 \= 0 ->
BabelExp_38 is 0,
babel_ptrE(__CIL_AP___CIL_RET8, BabelExp_38, 8),BABEL_RET is 1, true
; BabelExp_39 is __CIL_AP_TMP,
babelPtrR(__CIL_TMP29, BabelExp_39, 4),
BabelExp_40 is __CIL_TMP29 * 10,
babel_ptrE(__CIL_AP_TMP, BabelExp_40, 4),
BabelExp_41 is __CIL_AP_TMP,
babelPtrR(__CIL_TMP30, BabelExp_41, 4),
BabelExp_42 is __CIL_TMP30 + CUR_DIGIT_SSA_1,
babel_ptrE(__CIL_AP_TMP, BabelExp_42, 4),
BabelExp_43 is __CIL_AP_S,
babelPtrR(__CIL_TMP31, BabelExp_43, 8),
BabelExp_44 is __CIL_TMP31 +1* 1,
babel_ptrE(__CIL_AP_S, BabelExp_44, 8),
parse_number_cil_lr_1(__CIL_AP_NUM, __CIL_AP_S, __CIL_AP_MAX_NUM, __CIL_AP_TMP, __CIL_AP___CIL_RET8 , RETFLAG8_SSA_1),BABEL_RET is RETFLAG8_SSA_1, true)
; BABEL_RET is 0, true). 

 
copy_string_cil_lr_1(__CIL_AP_DST, __CIL_AP_SRC, __CIL_AP_I, VOID) :- 


 BabelExp_45 is __CIL_AP_I,
babelPtrR(__CIL_TMP7, BabelExp_45, 4),
...
(__CIL_TMP4 \= 0 ->
BabelExp_46 is __CIL_AP_SRC,
babelPtrR(__CIL_TMP8, BabelExp_46, 8),
BabelExp_47 is __CIL_AP_I,
babelPtrR(__CIL_TMP9, BabelExp_47, 4),
__CIL_TMP10 is __CIL_TMP8 +1* __CIL_TMP9,
BabelExp_48 is __CIL_TMP10,
babelPtrR_byte(__CIL_TMP11, BabelExp_48, 1),
__CIL_TMP12 is __CIL_TMP11,
...
(__CIL_TMP5 \= 0 ->
BabelExp_49 is __CIL_AP_SRC,
babelPtrR(__CIL_TMP13, BabelExp_49, 8),
BabelExp_50 is __CIL_AP_I,
babelPtrR(__CIL_TMP14, BabelExp_50, 4),
__CIL_TMP15 is __CIL_TMP13 +1* __CIL_TMP14,
BabelExp_51 is __CIL_TMP15,
babelPtrR_byte(__CIL_TMP16, BabelExp_51, 1),
__CIL_TMP17 is __CIL_TMP16,
...
(__CIL_TMP6 \= 0 ->
BabelExp_52 is __CIL_AP_SRC,
babelPtrR(__CIL_TMP18, BabelExp_52, 8),
BabelExp_53 is __CIL_AP_I,
babelPtrR(__CIL_TMP19, BabelExp_53, 4),
__CIL_TMP20 is __CIL_TMP18 +1* __CIL_TMP19,
BabelExp_54 is __CIL_TMP20,
babelPtrR_byte(__CIL_TMP21, BabelExp_54, 1),
BabelExp_55 is __CIL_AP_DST,
babelPtrR(__CIL_TMP22, BabelExp_55, 8),
BabelExp_56 is __CIL_AP_I,
babelPtrR(__CIL_TMP23, BabelExp_56, 4),
__CIL_TMP24 is __CIL_TMP22 +1* __CIL_TMP23,
BabelExp_57 is __CIL_TMP21,
babel_ptrE(__CIL_TMP24, BabelExp_57, 1),
BabelExp_58 is __CIL_AP_I,
babelPtrR(__CIL_TMP25, BabelExp_58, 4),
BabelExp_59 is __CIL_TMP25 + 1,
babel_ptrE(__CIL_AP_I, BabelExp_59, 4),
copy_string_cil_lr_1(__CIL_AP_DST, __CIL_AP_SRC, __CIL_AP_I, VOID),true
; true)
; true)
; true). 

 
:- foreign(babel__implicit_ftp_listener_stopc_0(+integer,  -integer)).
:- foreign(babel__implicit_ftp_listener_stopc_1(+string, +string, +integer, +string)).
:- foreign(babel__implicit_ftp_listener_stopc_2(+integer, +integer, +positive)).
:- foreign(babel__implicit_ftp_listener_stopc_3(+integer)).
:- foreign(babel__implicit_ftp_listener_stopc_4(+integer)).
:- foreign(babel__implicit_ftp_listener_stopc_5(+integer)).

ftp_listener_stop(__CIL_PP_F, __CIL_FP_F, F, VOID) :- 


 babel__implicit_ftp_listener_stopc_0(F , TMP_SSA_1),
(TMP_SSA_1 =:= 0 ->
babel__implicit_ftp_listener_stopc_1('invariant(f)', 'ftp_listener.c', 564, 'ftp_listener_stop')
; true),
__CIL_TMP7 is F +1* 4232,
__CIL_TMP8 is __CIL_TMP7,
BabelExp_0 is __CIL_TMP8,
babelPtrR(__CIL_TMP9, BabelExp_0, 4),
babel__implicit_ftp_listener_stopc_2(__CIL_TMP9, '', 1),
__CIL_TMP10 is F +1* 80,
babel__implicit_ftp_listener_stopc_3(__CIL_TMP10),
BabelExp_1 is F,
babel_ptrE(__CIL_FP_F, BabelExp_1, 8),
babel__implicit_ftp_listener_stopc_4(__CIL_PP_F),
BabelExp_2 is __CIL_FP_F,
babelPtrR(F_SSA_1, BabelExp_2, 8),
__CIL_TMP11 is F_SSA_1 +1* 80,
babel__implicit_ftp_listener_stopc_5(__CIL_TMP11),true. 

 :- foreign(babel__implicit_ftp_listener_stop_cil_lr_1c_6(+integer, +integer)).

ftp_listener_stop_cil_lr_1(__CIL_AP_F, VOID) :- 


 BabelExp_3 is __CIL_AP_F,
babelPtrR(__CIL_TMP3, BabelExp_3, 8),
__CIL_TMP4 is __CIL_TMP3,
__CIL_TMP5 is __CIL_TMP4 +1* 8,
__CIL_TMP6 is __CIL_TMP5,
BabelExp_4 is __CIL_TMP6,
babelPtrR(__CIL_TMP7, BabelExp_4, 4),
...
(__CIL_TMP2 \= 0 ->
BabelExp_5 is __CIL_AP_F,
babelPtrR(__CIL_TMP8, BabelExp_5, 8),
__CIL_TMP9 is __CIL_TMP8,
__CIL_TMP10 is __CIL_TMP9 +1* 4240,
BabelExp_6 is __CIL_AP_F,
babelPtrR(__CIL_TMP11, BabelExp_6, 8),
__CIL_TMP12 is __CIL_TMP11,
__CIL_TMP13 is __CIL_TMP12 +1* 80,
babel__implicit_ftp_listener_stop_cil_lr_1c_6(__CIL_TMP10, __CIL_TMP13),
ftp_listener_stop_cil_lr_1(__CIL_AP_F, VOID),true
; true). 

:- foreign(babel__implicit_print_usagec_0(+integer, +integer, +integer, +integer)).
:- foreign(babel__implicit_print_usagec_1(+integer, +integer, +integer)).
:- foreign(babel__implicit_print_usagec_2(+integer, +integer, +integer, +integer)).

print_usage(__CIL_GP_STDERR, __CIL_GP_EXE_NAME, ERROR, VOID) :- 
...
(__CIL_TMP4 \= 0 ->
BabelExp_0 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP5, BabelExp_0, 8),
BabelExp_1 is __CIL_GP_EXE_NAME,
babelPtrR(__CIL_TMP6, BabelExp_1, 8),
babel__implicit_print_usagec_0(__CIL_TMP5, '%S: %S\\N', __CIL_TMP6, ERROR)
; true),
BabelExp_2 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP7, BabelExp_2, 8),
BabelExp_3 is __CIL_GP_EXE_NAME,
babelPtrR(__CIL_TMP8, BabelExp_3, 8),
babel__implicit_print_usagec_1(__CIL_TMP7, ' SYNTAX: %S [ OPTIONS... ] USER_NAME ROOT_DIRECTORY\\N', __CIL_TMP8),
BabelExp_4 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP9, BabelExp_4, 8),
babel__implicit_print_usagec_2(__CIL_TMP9, ' OPTIONS:\\N -P, --PORT <NUM>\\N     SET THE PORT TO LISTEN ON (DEFAULT: %D)\\N -I, --INTERFACE <IP ADDRESS>\\N     SET THE INTERFACE TO LISTEN ON (DEFAULT: ALL)\\N -M, --MAX-CLIENTS <NUM>\\N     SET THE NUMBER OF CLIENTS ALLOWED AT ONE TIME (DEFAULT: %D)\\N-L, --LOCAL <LOCAL-LOGGING>\\N     USE LOCAL FACILITY FOR SYSLOG, LOCAL-LOGGING IS 0 TO 7\\N -N, --NODETACH\\N     DO NOT DETACH FROM TTY AND BECOME A DAEMON\\N', 21, 250),true. 

 :- foreign(babel__implicit_daemonizec_3(+string, +integer,  -integer)).
:- foreign(babel__implicit_daemonizec_4( -integer)).
:- foreign(babel__implicit_daemonizec_5(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_6(+integer, +integer, +integer, +integer)).
:- foreign(babel__implicit_daemonizec_7(+integer)).
:- foreign(babel__implicit_daemonizec_8(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_9( -integer)).
:- foreign(babel__implicit_daemonizec_10(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_11(+integer, +integer, +integer, +integer)).
:- foreign(babel__implicit_daemonizec_12(+integer)).
:- foreign(babel__implicit_daemonizec_13( -integer)).
:- foreign(babel__implicit_daemonizec_14( -integer)).
:- foreign(babel__implicit_daemonizec_15(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_16(+integer, +integer, +integer, +integer)).
:- foreign(babel__implicit_daemonizec_17(+integer)).
:- foreign(babel__implicit_daemonizec_18(+integer)).
:- foreign(babel__implicit_daemonizec_19( -integer)).
:- foreign(babel__implicit_daemonizec_20( -integer)).
:- foreign(babel__implicit_daemonizec_21(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_22(+integer, +integer, +integer, +integer)).
:- foreign(babel__implicit_daemonizec_23(+integer)).
:- foreign(babel__implicit_daemonizec_24( -integer)).
:- foreign(babel__implicit_daemonizec_25( -integer)).
:- foreign(babel__implicit_daemonizec_26(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_27(+integer, +integer, +integer, +integer)).
:- foreign(babel__implicit_daemonizec_28(+integer)).
:- foreign(babel__implicit_daemonizec_29(+integer)).
:- foreign(babel__implicit_daemonizec_30(+integer, +integer,  -integer)).
:- foreign(babel__implicit_daemonizec_31( -integer)).
:- foreign(babel__implicit_daemonizec_32(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_33(+integer, +string, +integer)).
:- foreign(babel__implicit_daemonizec_34(+integer)).
:- foreign(babel__implicit_daemonizec_35(+integer, +integer,  -integer)).
:- foreign(babel__implicit_daemonizec_36( -integer)).
:- foreign(babel__implicit_daemonizec_37(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_38(+integer, +string, +integer)).
:- foreign(babel__implicit_daemonizec_39(+integer)).
:- foreign(babel__implicit_daemonizec_40(+integer, +integer,  -integer)).
:- foreign(babel__implicit_daemonizec_41( -integer)).
:- foreign(babel__implicit_daemonizec_42(+integer,  -integer)).
:- foreign(babel__implicit_daemonizec_43(+integer, +string, +integer)).
:- foreign(babel__implicit_daemonizec_44(+integer)).
:- foreign(babel__implicit_daemonizec_45(+integer, +integer)).

daemonize(__CIL_GP_STDERR, __CIL_GP_EXE_NAME, ARGC, ARGV, VOID) :- 


 babel__implicit_daemonizec_3('/dev/null', 2 , NULL_FD_SSA_1),
...
(__CIL_TMP54 \= 0 ->
babel__implicit_daemonizec_4(TMP_SSA_1),
BabelExp_5 is TMP_SSA_1,
babelPtrR(__CIL_TMP64, BabelExp_5, 4),
babel__implicit_daemonizec_5(__CIL_TMP64 , TMP___0_SSA_1),
BabelExp_6 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP65, BabelExp_6, 8),
BabelExp_7 is __CIL_GP_EXE_NAME,
babelPtrR(__CIL_TMP66, BabelExp_7, 8),
babel__implicit_daemonizec_6(__CIL_TMP65, '%S: ERROR OPENING NULL OUTPUT DEVICE; %S\\N', __CIL_TMP66, TMP___0_SSA_1),
babel__implicit_daemonizec_7(1)
; true),
babel__implicit_daemonizec_8(4 , TMP___1_SSA_1),
MAX_FD_SSA_1 is TMP___1_SSA_1,
...
(__CIL_TMP55 \= 0 ->
babel__implicit_daemonizec_9(TMP___2_SSA_1),
BabelExp_8 is TMP___2_SSA_1,
babelPtrR(__CIL_TMP67, BabelExp_8, 4),
babel__implicit_daemonizec_10(__CIL_TMP67 , TMP___3_SSA_1),
BabelExp_9 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP68, BabelExp_9, 8),
BabelExp_10 is __CIL_GP_EXE_NAME,
babelPtrR(__CIL_TMP69, BabelExp_10, 8),
babel__implicit_daemonizec_11(__CIL_TMP68, '%S: ERROR GETTING MAXIMUM OPEN FILE; %S\\N', __CIL_TMP69, TMP___3_SSA_1),
babel__implicit_daemonizec_12(1)
; true),
babel__implicit_daemonizec_13(FORK_RET_SSA_1),
...
(__CIL_TMP56 \= 0 ->
babel__implicit_daemonizec_14(TMP___4_SSA_1),
BabelExp_11 is TMP___4_SSA_1,
babelPtrR(__CIL_TMP70, BabelExp_11, 4),
babel__implicit_daemonizec_15(__CIL_TMP70 , TMP___5_SSA_1),
BabelExp_12 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP71, BabelExp_12, 8),
BabelExp_13 is __CIL_GP_EXE_NAME,
babelPtrR(__CIL_TMP72, BabelExp_13, 8),
babel__implicit_daemonizec_16(__CIL_TMP71, '%S: ERROR FORKING; %S\\N', __CIL_TMP72, TMP___5_SSA_1),
babel__implicit_daemonizec_17(1)
; true),
...
(__CIL_TMP57 \= 0 ->
babel__implicit_daemonizec_18(0)
; true),
babel__implicit_daemonizec_19(TMP___8_SSA_1),
...
(__CIL_TMP58 \= 0 ->
babel__implicit_daemonizec_20(TMP___6_SSA_1),
BabelExp_14 is TMP___6_SSA_1,
babelPtrR(__CIL_TMP73, BabelExp_14, 4),
babel__implicit_daemonizec_21(__CIL_TMP73 , TMP___7_SSA_1),
BabelExp_15 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP74, BabelExp_15, 8),
BabelExp_16 is __CIL_GP_EXE_NAME,
babelPtrR(__CIL_TMP75, BabelExp_16, 8),
babel__implicit_daemonizec_22(__CIL_TMP74, '%S: ERROR CREATING PROCESS GROUP; %S\\N', __CIL_TMP75, TMP___7_SSA_1),
babel__implicit_daemonizec_23(1)
; true),
babel__implicit_daemonizec_24(FORK_RET_SSA_2),
...
(__CIL_TMP59 \= 0 ->
babel__implicit_daemonizec_25(TMP___9_SSA_1),
BabelExp_17 is TMP___9_SSA_1,
babelPtrR(__CIL_TMP76, BabelExp_17, 4),
babel__implicit_daemonizec_26(__CIL_TMP76 , TMP___10_SSA_1),
BabelExp_18 is __CIL_GP_STDERR,
babelPtrR(__CIL_TMP77, BabelExp_18, 8),
BabelExp_19 is __CIL_GP_EXE_NAME,
babelPtrR(__CIL_TMP78, BabelExp_19, 8),
babel__implicit_daemonizec_27(__CIL_TMP77, '%S: ERROR FORKING; %S\\N', __CIL_TMP78, TMP___10_SSA_1),
babel__implicit_daemonizec_28(1)
; true),
...
(__CIL_TMP60 \= 0 ->
babel__implicit_daemonizec_29(0)
; true),
babel__implicit_daemonizec_30(NULL_FD_SSA_1, 0 , TMP___13_SSA_1),
...
(__CIL_TMP61 \= 0 ->
babel__implicit_daemonizec_31(TMP___11_SSA_1),
BabelExp_20 is TMP___11_SSA_1,
babelPtrR(__CIL_TMP79, BabelExp_20, 4),
babel__implicit_daemonizec_32(__CIL_TMP79 , TMP___12_SSA_1),
babel__implicit_daemonizec_33(3, 'error setting input to null; %s', TMP___12_SSA_1),
babel__implicit_daemonizec_34(1)
; true),
babel__implicit_daemonizec_35(NULL_FD_SSA_1, 1 , TMP___16_SSA_1),
...
(__CIL_TMP62 \= 0 ->
babel__implicit_daemonizec_36(TMP___14_SSA_1),
BabelExp_21 is TMP___14_SSA_1,
babelPtrR(__CIL_TMP80, BabelExp_21, 4),
babel__implicit_daemonizec_37(__CIL_TMP80 , TMP___15_SSA_1),
babel__implicit_daemonizec_38(3, 'error setting output to null; %s', TMP___15_SSA_1),
babel__implicit_daemonizec_39(1)
; true),
babel__implicit_daemonizec_40(NULL_FD_SSA_1, 2 , TMP___19_SSA_1),
...
(__CIL_TMP63 \= 0 ->
babel__implicit_daemonizec_41(TMP___17_SSA_1),
BabelExp_22 is TMP___17_SSA_1,
babelPtrR(__CIL_TMP81, BabelExp_22, 4),
babel__implicit_daemonizec_42(__CIL_TMP81 , TMP___18_SSA_1),
babel__implicit_daemonizec_43(3, 'error setting error output to null; %s', TMP___18_SSA_1),
babel__implicit_daemonizec_44(1)
; true),
FD_SSA_1 is 3,
babel__implicit_daemonizec_45(MAX_FD_SSA_1, FD_SSA_1),true. 

:- foreign(babel__implicit_daemonize_cil_lr_1c_46(+integer)).

daemonize_cil_lr_1(MAX_FD, FD, VOID) :- 
...
(__CIL_TMP4 \= 0 ->
babel__implicit_daemonize_cil_lr_1c_46(FD),
BabelExp_23 is FD + 1,
FD_SSA_1 is BabelExp_23,
daemonize_cil_lr_1(MAX_FD, FD_SSA_1, VOID),true
; true). 
