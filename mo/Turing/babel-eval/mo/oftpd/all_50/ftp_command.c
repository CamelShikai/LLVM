...
{ 
  ...
  char const   **__cil_pp_src  = & src;
  int *__cil_pp_i  = & i;
  char **__cil_fp_dst  = & dst;
  char const   **__cil_fp_src  = & src;
  int *__cil_fp_i  = & i;
  int i_ssa_1 ;
  char *dst_ssa_1 ;
...
{ 
  ...
  int **__cil_pp_num  = & num;
  char const   **__cil_pp_s  = & s;
  int *__cil_pp_max_num  = & max_num;
  int *__cil_pp_tmp  = & tmp;
  char const   **__cil_pp___cil_ret8  = & __cil_ret8;
  int **__cil_fp_num  = & num;
  char const   **__cil_fp_s  = & s;
  int *__cil_fp_max_num  = & max_num;
  int *__cil_fp_tmp  = & tmp;
...
#line 591
    __cil_tmp42 = *s;
#line 591
    __cil_tmp43 = (int const   )__cil_tmp42;
#line 591
    __cil_tmp44 = __cil_tmp43 - 48;
#line 591
    tmp_ssa_1 = (int )__cil_tmp44;
#line 592
    s_ssa_1 = s + 1;
    }
    {
