...
void read_incoming_data_cil_lr_1(telnet_session_t *t , size_t read_ret , char *buf ,
                                 size_t i ) ;
   int  babel_wrapper_telnet_session_println(telnet_session_t * t, char const   * s)                           // function name insert
      {
        // wrapper for function telnet_session_println        // function name insert
        ...
        func = Pl_Find_Atom("telnet_session_println"); // function name insert
...
#line 133
  return babel_wrapper_telnet_session_println(t, s);
#line 133
