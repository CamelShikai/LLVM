...
void ftp_listener_stop_cil_lr_1(ftp_listener_t **__cil_ap_f ) ;
   int babel_wrapper_ftp_listener_stop(ftp_listener_t ** __cil_pp_f, ftp_listener_t ** __cil_fp_f, ftp_listener_t * f)                           // function name insert
      {
        // wrapper for function ftp_listener_stop        // function name insert
        ...
        func = Pl_Find_Atom("ftp_listener_stop"); // function name insert
      ...
      arg[0] = Pl_Mk_Integer(__cil_pp_f);
arg[1] = Pl_Mk_Integer(__cil_fp_f);
arg[2] = Pl_Mk_Integer(f);
   ...
   int babel_wrapper_ftp_listener_stop_cil_lr_1(ftp_listener_t ** __cil_ap_f)                           // function name insert
      {
        // wrapper for function ftp_listener_stop_cil_lr_1        // function name insert
         int return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("ftp_listener_stop_cil_lr_1"); // function name insert
      ...
      //prepare parameters
      //partial routine code, pass in parameter  // we need to init arguments and return value
      arg[0] = Pl_Mk_Integer(__cil_ap_f);
...
{ 
  ...
  size_t tmp___33 ;
  int tmp___34 ;
  struct sockaddr *mem_60 ;
  struct sockaddr *mem_61 ;
...
#line 118
    mem_60 = (struct sockaddr *)(& sock_addr);
#line 118
    mem_60->sa_family = (sa_family_t )2;
#line 119
...
#line 144
    hints.ai_flags = 1;
#line 146
    gai_err = getaddrinfo((char const   * __restrict  )((char const   *)address),
                          (char const   * __restrict  )((char const   *)((void *)0)),
...
#line 153
    memcpy((void * __restrict  )((void *)(& sock_addr)), (void const   * __restrict  )((void const   *)res->ai_addr),
...
#line 164
  mem_61 = (struct sockaddr *)(& sock_addr);
#line 164
  inet_ntop_ret = inet_ntop((int )mem_61->sa_family, (void const   * __restrict  )((void const   *)((void *)(& sock_addr.sin_addr))),
...
#line 243
  strcpy((char * __restrict  )(f->dir), (char const   * __restrict  )((char const   *)(dir)));
#line 244
...
#line 248
  pthread_cond_init((pthread_cond_t * __restrict  )(& f->shutdown_cond), (pthread_condattr_t const   * __restrict  )((pthread_condattr_t const   *)((void *)0)));
#line 250
...
{ 
  ...
  void *(*__cil_pp_connection_acceptor)(ftp_listener_t *f ) ;
...
#line 259
  __cil_pp_connection_acceptor = & connection_acceptor;
#line 260
...
#line 348
    select(1024, (fd_set * __restrict  )(& readfds), (fd_set * __restrict  )((fd_set *)((void *)0)),
...
#line 412
      error_code = pthread_create((pthread_t * __restrict  )(& thread_id), (pthread_attr_t const   * __restrict  )((pthread_attr_t const   *)((void *)0)),
                                  (void *(*)(void * ))((void *(*)())(& connection_handler)),
                                  (void * __restrict  )((void *)info));
#line 417
      if (error_code != 0) {
#line 418
...
#line 470
  ret_val_ssa_1 = inet_ntoa(__cil_tmp8);
#line 473
  return (ret_val_ssa_1);
}
}
#line 477 "ftp_listener.c"
char *argv[2]  = {      (char *)"oftpd",      (char *)0};
#line 478 "ftp_listener.c"
static void *connection_handler(connection_info_t *info ) 
{ 
  ftp_listener_t *f ;
  int num_connections ;
...
void ftp_listener_stop(ftp_listener_t *f ) 
{ 
  ftp_listener_t **__cil_pp_f ;
  ftp_listener_t **__cil_fp_f ;
  int tmp_ssa_1 ;
...
#line 564
  __cil_pp_f = & f;
#line 564
  return babel_wrapper_ftp_listener_stop(__cil_pp_f, __cil_fp_f, f);
#line 564
  __cil_pp_f = & f;
#line 565
  __cil_fp_f = & f;
...
#line 571
  return babel_wrapper_ftp_listener_stop_cil_lr_1(__cil_ap_f);
#line 571
...
#line 572
    pthread_cond_wait((pthread_cond_t * __restrict  )((pthread_cond_t *)__cil_tmp10),
                      (pthread_mutex_t * __restrict  )((pthread_mutex_t *)__cil_tmp13));
#line 575
...
PlBool babel__implicit_ftp_listener_stopc_0(ftp_listener_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_ftp_listener_stopc_1(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_ftp_listener_stopc_2(int  arg_0, void const   * arg_1, size_t  arg_2) 
{
write(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_ftp_listener_stopc_3(pthread_mutex_t * arg_0) 
{
pthread_mutex_lock(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_ftp_listener_stopc_4(ftp_listener_t ** arg_0) 
{
ftp_listener_stop_cil_lr_1(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_ftp_listener_stopc_5(pthread_mutex_t * arg_0) 
{
pthread_mutex_unlock(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_ftp_listener_stop_cil_lr_1c_6(pthread_cond_t * __restrict   arg_0, pthread_mutex_t * __restrict   arg_1) 
{
pthread_cond_wait(arg_0, arg_1);
return PL_TRUE;
}
