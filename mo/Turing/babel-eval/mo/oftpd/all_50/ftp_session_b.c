...
arg[1] = Pl_Mk_Integer(reason);
   ...
   int babel_wrapper_ftp_session_destroy(ftp_session_t * f)                           // function name insert
      {
        // wrapper for function ftp_session_destroy        // function name insert
         int return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("ftp_session_destroy"); // function name insert
...
arg[1] = Pl_Mk_Integer(cmd);
   ...
   int babel_wrapper_do_pass(ftp_session_t * f, ftp_command_t const   * cmd)                           // function name insert
      {
        // wrapper for function do_pass        // function name insert
         int return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("do_pass"); // function name insert
...
arg[1] = Pl_Mk_Integer(cmd);
   ...
   int babel_wrapper_do_cdup(ftp_session_t * f, ftp_command_t const   * cmd)                           // function name insert
      {
        // wrapper for function do_cdup        // function name insert
         int return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("do_cdup"); // function name insert
...
arg[1] = Pl_Mk_Integer(cmd);
   ...
   int babel_wrapper_do_stru(ftp_session_t * f, ftp_command_t const   * cmd)                           // function name insert
      {
        // wrapper for function do_stru        // function name insert
         int return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("do_stru"); // function name insert
...
arg[3] = Pl_Mk_Integer(file);
   ...
   int babel_wrapper_do_stor(ftp_session_t * f, ftp_command_t const   * cmd)                           // function name insert
      {
        // wrapper for function do_stor        // function name insert
         int return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("do_stor"); // function name insert
...
arg[1] = Pl_Mk_Integer(cmd);
   ...
   int  babel_wrapper_open_connection(struct sockaddr_in * __cil_pp_addr, unsigned int * __cil_pp_addr_len, unsigned int * __cil_fp_addr_len, ftp_session_t * f)                           // function name insert
      {
        // wrapper for function open_connection        // function name insert
         int  return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("open_connection"); // function name insert
      ...
      //prepare parameters
      //partial routine code, pass in parameter  // we need to init arguments and return value
      arg[0] = Pl_Mk_Integer(__cil_pp_addr);
arg[1] = Pl_Mk_Integer(__cil_pp_addr_len);
arg[2] = Pl_Mk_Integer(__cil_fp_addr_len);
arg[3] = Pl_Mk_Integer(f);
...
arg[6] = Pl_Mk_Integer(buflen);
   ...
   int babel_wrapper_do_pwd(ftp_session_t * f, ftp_command_t const   * cmd)                           // function name insert
      {
        // wrapper for function do_pwd        // function name insert
         int return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("do_pwd"); // function name insert
...
arg[1] = Pl_Mk_Integer(cmd);
   ...
   int babel_wrapper_do_noop(ftp_session_t * f, ftp_command_t const   * cmd)                           // function name insert
      {
        // wrapper for function do_noop        // function name insert
         int return_value; //  return value type (how about array type)
        ...
        func = Pl_Find_Atom("do_noop"); // function name insert
...
#line 286
  return babel_wrapper_ftp_session_destroy(f);
#line 286
  tmp_ssa_1 = invariant((ftp_session_t const   *)f);
#line 286
  if (tmp_ssa_1 == 0) {
...
#line 402
  return babel_wrapper_do_pass(f, cmd);
#line 402
  tmp_ssa_1 = invariant((ftp_session_t const   *)f);
#line 402
  if (tmp_ssa_1 == 0) {
...
#line 479
  return babel_wrapper_do_cdup(f, cmd);
#line 479
  tmp_ssa_1 = invariant((ftp_session_t const   *)f);
#line 479
  if (tmp_ssa_1 == 0) {
...
#line 990
  return babel_wrapper_do_stru(f, cmd);
#line 990
  tmp_ssa_1 = invariant((ftp_session_t const   *)f);
#line 990
  if (tmp_ssa_1 == 0) {
...
#line 1269
  return babel_wrapper_do_stor(f, cmd);
#line 1269
  tmp_ssa_1 = invariant((ftp_session_t const   *)f);
#line 1269
  if (tmp_ssa_1 == 0) {
...
{ 
  ...
  struct sockaddr_in *__cil_pp_addr ;
  unsigned int *__cil_pp_addr_len ;
  unsigned int *__cil_fp_addr_len ;
  int socket_fd_ssa_1 ;
  int *tmp_ssa_1 ;
  char *tmp___0_ssa_1 ;
  int tmp___3_ssa_1 ;
  ...
  {
#line 1282
  __cil_fp_addr_len = & addr_len;
#line 1282
  __cil_pp_addr_len = & addr_len;
#line 1282
  __cil_pp_addr = & addr;
#line 1282
  return babel_wrapper_open_connection(__cil_pp_addr, __cil_pp_addr_len, __cil_fp_addr_len,
                                       f);
#line 1282
  __cil_pp_addr = & addr;
#line 1283
...
#line 1304
    socket_fd_ssa_1 = accept(__cil_tmp55, (struct sockaddr * __restrict  )((struct sockaddr *)__cil_pp_addr),
...
#line 1376
  return babel_wrapper_do_pwd(f, cmd);
#line 1376
  tmp_ssa_1 = invariant((ftp_session_t const   *)f);
#line 1376
  if (tmp_ssa_1 == 0) {
...
#line 1588
  return babel_wrapper_do_noop(f, cmd);
#line 1588
  tmp_ssa_1 = invariant((ftp_session_t const   *)f);
#line 1588
  if (tmp_ssa_1 == 0) {
...
PlBool babel__implicit_ftp_session_destroyc_6(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_ftp_session_destroyc_7(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_ftp_session_destroyc_8(int  arg_0) 
{
close(arg_0);
return PL_TRUE;
}
...
PlBool babel__implicit_do_passc_21(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_passc_22(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_passc_23(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_passc_24(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_passc_25(int arg_0, char* arg_1, char * arg_2, char const   * arg_3) 
{
syslog(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_passc_26(ftp_session_t * arg_0, int arg_1, char* arg_2) 
{
reply(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_do_passc_27(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_passc_28(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
...
PlBool babel__implicit_do_cdupc_36(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_cdupc_37(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_cdupc_38(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_cdupc_39(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_cdupc_40(ftp_session_t * arg_0, char* arg_1) 
{
change_dir(arg_0, arg_1);
return PL_TRUE;
}
PlBool babel__implicit_do_cdupc_41(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_cdupc_42(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
...
PlBool babel__implicit_do_struc_88(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_struc_89(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_struc_90(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_struc_91(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_struc_92(ftp_session_t * arg_0, int arg_1, char* arg_2) 
{
reply(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_do_struc_93(ftp_session_t * arg_0, int arg_1, char* arg_2) 
{
reply(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_do_struc_94(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_struc_95(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
...
PlBool babel__implicit_do_storc_116(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_storc_117(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_storc_118(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_storc_119(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_storc_120(ftp_session_t * arg_0, int arg_1, char* arg_2) 
{
reply(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_do_storc_121(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_storc_122(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_123(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_124(int  arg_0, int arg_1, int arg_2, PlLong * babel_ret) 
{
*babel_ret = socket(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_125(PlLong * babel_ret) 
{
*babel_ret = __errno_location();
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_126(int  arg_0, PlLong * babel_ret) 
{
*babel_ret = strerror(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_127(ftp_session_t * arg_0, int arg_1, char* arg_2, char * arg_3) 
{
reply(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_128(int  arg_0, struct sockaddr  const  * arg_1, socklen_t  arg_2, PlLong * babel_ret) 
{
*babel_ret = connect(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_129(PlLong * babel_ret) 
{
*babel_ret = __errno_location();
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_130(int  arg_0, PlLong * babel_ret) 
{
*babel_ret = strerror(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_131(ftp_session_t * arg_0, int arg_1, char* arg_2, char * arg_3) 
{
reply(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_132(int  arg_0) 
{
close(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_133(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_134(int  arg_0, struct sockaddr * __restrict   arg_1, socklen_t * __restrict   arg_2, PlLong * babel_ret) 
{
*babel_ret = accept(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_135(PlLong * babel_ret) 
{
*babel_ret = __errno_location();
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_136(int  arg_0, PlLong * babel_ret) 
{
*babel_ret = strerror(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_137(ftp_session_t * arg_0, int arg_1, char* arg_2, char * arg_3) 
{
reply(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_138(void const   * arg_0, void const   * arg_1, int arg_2, PlLong * babel_ret) 
{
*babel_ret = memcmp(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_139(ftp_session_t * arg_0, int arg_1, char* arg_2) 
{
reply(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_open_connectionc_140(int  arg_0) 
{
close(arg_0);
return PL_TRUE;
}
...
PlBool babel__implicit_do_pwdc_145(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_pwdc_146(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_pwdc_147(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_pwdc_148(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_pwdc_149(ftp_session_t * arg_0, int arg_1, char* arg_2, char * arg_3) 
{
reply(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_pwdc_150(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_pwdc_151(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
...
PlBool babel__implicit_do_noopc_164(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_noopc_165(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_noopc_166(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_noopc_167(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
PlBool babel__implicit_do_noopc_168(ftp_session_t * arg_0, int arg_1, char* arg_2) 
{
reply(arg_0, arg_1, arg_2);
return PL_TRUE;
}
PlBool babel__implicit_do_noopc_169(ftp_session_t const   * arg_0, PlLong * babel_ret) 
{
*babel_ret = invariant(arg_0);
return PL_TRUE;
}
PlBool babel__implicit_do_noopc_170(char* arg_0, char* arg_1, int arg_2, char* arg_3) 
{
daemon_assert_fail(arg_0, arg_1, arg_2, arg_3);
return PL_TRUE;
}
