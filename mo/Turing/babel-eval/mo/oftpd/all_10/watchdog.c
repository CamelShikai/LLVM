...
# 20 "watchdog.c" 3 4
   ((void *)0)
# 20 "watchdog.c"
   ) ? 0 : (daemon_assert_fail("w != ((void *)0)", "watchdog.c", 20, __func__)));
    ((inactivity_timeout > 0) ? 0 : (daemon_assert_fail("inactivity_timeout > 0", "watchdog.c", 21, __func__)));
    ((err != 
# 22 "watchdog.c" 3 4
   ((void *)0)
# 22 "watchdog.c"
   ) ? 0 : (daemon_assert_fail("err != ((void *)0)", "watchdog.c", 22, __func__)));

    pthread_mutex_init(&w->mutex, 
# 24 "watchdog.c" 3 4
                                 ((void *)0)
# 24 "watchdog.c"
                                     );
...
# 29 "watchdog.c"
 ...
 error_init(err, error_code, "error %d from pthread_create()",
   error_code);
    ...
    ((invariant(w)) ? 0 : (daemon_assert_fail("invariant(w)", "watchdog.c", 37, __func__)));
...
void watchdog_add_watched(watchdog_t *w, watched_t *watched)
{
    ((invariant(w)) ? 0 : (daemon_assert_fail("invariant(w)", "watchdog.c", 44, __func__)));
    ...
    ((invariant(w)) ? 0 : (daemon_assert_fail("invariant(w)", "watchdog.c", 54, __func__)));
}
...
void watchdog_defer_watched(watched_t *watched)
{
    ...
    ((invariant(watched->watchdog)) ? 0 : (daemon_assert_fail("invariant(watched->watchdog)", "watchdog.c", 61, __func__)));
    ...
    pthread_mutex_unlock(&w->mutex);
    ((invariant(w)) ? 0 : (daemon_assert_fail("invariant(w)", "watchdog.c", 70, __func__)));
}
...
void watchdog_remove_watched(watched_t *watched)
{
    ...
    ((invariant(watched->watchdog)) ? 0 : (daemon_assert_fail("invariant(watched->watchdog)", "watchdog.c", 77, __func__)));
    ...
    pthread_mutex_unlock(&w->mutex);
    ((invariant(w)) ? 0 : (daemon_assert_fail("invariant(w)", "watchdog.c", 85, __func__)));
}
...
static void insert(watchdog_t *w, watched_t *watched)
{
    ...
    watched->alarm_time = time(
# 94 "watchdog.c" 3 4
                              ((void *)0)
# 94 "watchdog.c"
                                  ) + w->inactivity_timeout;
# 104 "watchdog.c"
    if (w->newest != 
# 104 "watchdog.c" 3 4
                    ((void *)0)
...
# 130 "watchdog.c"
        ...
        ((w->newest == watched) ? 0 : (daemon_assert_fail("w->newest == watched", "watchdog.c", 131, __func__)));
...
# 134 "watchdog.c"
        ...
        ((w->newest != watched) ? 0 : (daemon_assert_fail("w->newest != watched", "watchdog.c", 137, __func__)));
...
# 141 "watchdog.c"
        ...
        ((w->oldest == watched) ? 0 : (daemon_assert_fail("w->oldest == watched", "watchdog.c", 142, __func__)));
...
# 145 "watchdog.c"
        ...
        ((w->oldest != watched) ? 0 : (daemon_assert_fail("w->oldest != watched", "watchdog.c", 148, __func__)));
