...
:-foreign(babel_ptrR1(-integer, +integer)).
:-foreign(babel_ptrR2(-integer, +integer)).
:-foreign(babel_ptrR4(-integer, +integer)).
:-foreign(babel_ptrR8(-integer, +integer)).
...
babel_ptrR8(CP_SSA_1, BabelExp_5),
BabelExp_6 is __CIL_FP_RET,
babel_ptrR8(RET_SSA_2, BabelExp_6),
BabelExp_7 is __CIL_FP_CHAIN,
babel_ptrR8(CHAIN_SSA_2, BabelExp_7),
BabelExp_8 is __CIL_FP___CIL_RET8,
babel_ptrR8(__CIL_RET8_SSA_1, BabelExp_8),
(RETFLAG9_SSA_1 \= 0 ,
R is __CIL_RET8_SSA_1, true
; (CHAIN_SSA_2 =:= 0 ,
__CIL_TMP25 is 1
; __CIL_TMP25 is 0),
...
babel_ptrR8(__CIL_TMP30, BabelExp_11),
__CIL_TMP31 is CP +1* 32,
__CIL_TMP32 is __CIL_TMP31,
BabelExp_12 is __CIL_TMP30 + 3,
babel_ptrE(__CIL_TMP32, BabelExp_12, 8),R is RET_SSA_1, true
...
babel_ptrE(__CIL_TMP34, BabelExp_16, 8),R is RET_SSA_1, true). 
...
babel_ptrR8(__CIL_TMP8, BabelExp_17),
...
babel_ptrR8(__CIL_TMP23, BabelExp_22),
...
babel_ptrR8(__CIL_TMP18, BabelExp_24),
...
babel_ptrR8(__CIL_TMP27, BabelExp_25),
__CIL_TMP28 is CP +1* 32,
__CIL_TMP29 is __CIL_TMP28,
...
babel_ptrR8(__CIL_TMP33, BabelExp_27),
...
babel_ptrR8(__CIL_TMP37, BabelExp_29),
...
babel_ptrR8(__CIL_TMP19, BabelExp_34),
...
babel_ptrR8(VAL_SSA_1, BabelExp_37),
BabelExp_38 is __CIL_FP_SCAN,
babel_ptrR8(SCAN_SSA_2, BabelExp_38),
...
babel_ptrR8(__CIL_TMP8, BabelExp_52),
__CIL_TMP9 is CP +1* 24,
__CIL_TMP10 is __CIL_TMP9,
__CIL_TMP11 is __CIL_TMP10,
__CIL_TMP12 is __CIL_TMP8,
...
babel_ptrR8(EP_SSA_1, BabelExp_58),
BabelExp_59 is __CIL_FP_PROG,
babel_ptrR8(PROG_SSA_1, BabelExp_59),
BabelExp_60 is __CIL_FP_STRING,
babel_ptrR8(STRING_SSA_1, BabelExp_60),
...
__CIL_TMP34 is __CIL_TMP33,
MEM_32 is EP_SSA_1,
babel_ptrR8(BabelExp_62, MEM_32),
babel_ptrE(__CIL_TMP34, BabelExp_62, 8),R is 1, true
; R is 0, true). 
...
babel_ptrR8(__CIL_TMP24, BabelExp_64),
babel__implicit_regrepeatc_8(__CIL_TMP24 , TMP_SSA_1),R is TMP_SSA_1, true
; (NV_SSA_1 =:= 8 ,
__CIL_TMP21 is 1
; __CIL_TMP21 is 0),
...
babel_ptrR8(SCAN_SSA_1, BabelExp_66),
...
babel_ptrR8(COUNT_SSA_2, BabelExp_68),R is COUNT_SSA_2, true
; (NV_SSA_1 =:= 4 ,
__CIL_TMP22 is 1
; __CIL_TMP22 is 0),
...
babel_ptrR8(__CIL_TMP26, BabelExp_69),
__CIL_TMP27 is NODE +1* 3,
babel__implicit_regrepeatc_10(__CIL_TMP26, __CIL_TMP27 , TMP___0_SSA_1),R is TMP___0_SSA_1, true
; (NV_SSA_1 =:= 5 ,
__CIL_TMP23 is 1
; __CIL_TMP23 is 0),
...
babel_ptrR8(__CIL_TMP28, BabelExp_70),
__CIL_TMP29 is NODE +1* 3,
babel__implicit_regrepeatc_11(__CIL_TMP28, __CIL_TMP29 , TMP___1_SSA_1),R is TMP___1_SSA_1, true
; babel__implicit_regrepeatc_12('INTERNAL ERROR: BAD CALL OF REGREPEAT'),R is 0, true)))). 
...
babel_ptrR8(__CIL_TMP8, BabelExp_79),
...
babel_ptrR8(__CIL_TMP6, BabelExp_84),
...
babel_ptrR8(__CIL_TMP21, BabelExp_86),
__CIL_TMP22 is __CIL_TMP21,
BabelExp_87 is __CIL_TMP22,
babel_ptrR8(__CIL_TMP23, BabelExp_87),
...
(__CIL_TMP19 \= 0 ,
BabelExp_92 is 0,
babel_ptrE(__CIL_AP___CIL_RET8, BabelExp_92, 8),R is 1, true
; BabelExp_93 is FLAGP,
babel_ptrR4(__CIL_TMP26, BabelExp_93),
...
babel_ptrR8(__CIL_TMP28, BabelExp_96),
__CIL_TMP29 is __CIL_TMP28,
...
babel_ptrR4(__CIL_TMP30, BabelExp_97),
...
babel_ptrR8(__CIL_TMP32, BabelExp_100),
BabelExp_101 is __CIL_AP_CHAIN,
babel_ptrR8(__CIL_TMP33, BabelExp_101),
...
babel__implicit_regbranch_cil_lr_1c_19(__CIL_AP_CP, __CIL_AP_RET, __CIL_AP_CHAIN, __CIL_AP___CIL_RET8, FLAGP, FLAGS_SSA_1 , RETFLAG9_SSA_1),R is RETFLAG9_SSA_1, true),
BabelExp_103 is LATEST,
babel_ptrE(__CIL_AP_CHAIN, BabelExp_103, 8),
babel__implicit_regbranch_cil_lr_1c_20(__CIL_AP_CP, __CIL_AP_RET, __CIL_AP_CHAIN, __CIL_AP___CIL_RET8, FLAGP, FLAGS , RETFLAG9_SSA_1),R is RETFLAG9_SSA_1, true
; R is 0, true)
; R is 0, true)
; R is 0, true),
BabelExp_104 is LATEST,
babel_ptrE(__CIL_AP_CHAIN, BabelExp_104, 8),
babel__implicit_regbranch_cil_lr_1c_21(__CIL_AP_CP, __CIL_AP_RET, __CIL_AP_CHAIN, __CIL_AP___CIL_RET8, FLAGP, FLAGS , RETFLAG9_SSA_1),R is RETFLAG9_SSA_1, true. 

 
:- foreign(babel__implicit_regerrorc_0(+integer, +integer)).

regerror(__CIL_GP_ERRREPORT, __CIL_GP_ERRSEEN, S, VOID) :- 


 BabelExp_0 is __CIL_GP_ERRREPORT,
babel_ptrR4(__CIL_TMP4, BabelExp_0),
(__CIL_TMP4 \= 0 ,
BabelExp_1 is S,
babel_ptrE(__CIL_GP_ERRSEEN, BabelExp_1, 8)
; babel__implicit_regerrorc_0(S, '')),
true. 

 :- foreign(babel__implicit_complainc_1(+integer, +integer, +integer)).
:- foreign(babel__implicit_complainc_2(+integer, +integer, +integer)).
:- foreign(babel__implicit_complainc_3(+integer, +integer, +integer)).

complain(__CIL_GP_STDERR, __CIL_GP_LINENO, __CIL_GP_ERRSEEN, __CIL_GP_STATUS, S1, S2, R) :- 


 BabelExp_2 is __CIL_GP_STDERR,
babel_ptrR8(__CIL_TMP10, BabelExp_2),
BabelExp_3 is __CIL_GP_LINENO,
babel_ptrR4(__CIL_TMP11, BabelExp_3),
babel__implicit_complainc_1(__CIL_TMP10, 'TRY: %D: ', __CIL_TMP11),
BabelExp_4 is __CIL_GP_STDERR,
babel_ptrR8(__CIL_TMP12, BabelExp_4),
babel__implicit_complainc_2(__CIL_TMP12, S1, S2),
BabelExp_5 is __CIL_GP_ERRSEEN,
babel_ptrR8(__CIL_TMP13, BabelExp_5),
__CIL_TMP14 is __CIL_TMP13,
...
(__CIL_TMP9 \= 0 ,
BabelExp_6 is __CIL_GP_ERRSEEN,
babel_ptrR8(__CIL_TMP15, BabelExp_6),
TMP_SSA_1 is __CIL_TMP15
; babelAssignStr(TMP_SSA_1, '')),
BabelExp_7 is __CIL_GP_STDERR,
babel_ptrR8(__CIL_TMP16, BabelExp_7),
babel__implicit_complainc_3(__CIL_TMP16, ' (%S)\\N', TMP_SSA_1),
BabelExp_8 is 1,
babel_ptrE(__CIL_GP_STATUS, BabelExp_8, 4),R is 0, true. 
