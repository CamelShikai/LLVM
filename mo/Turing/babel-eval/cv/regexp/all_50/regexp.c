 ...
 */
static char *
__attribute__((noinline)) regbranch(cp, flagp)
register struct comp *cp;
int *flagp;
{
	register char *ret;
...
__attribute__((noinline)) regnode(cp, op)
register struct comp *cp;
char op;
{
VIRTUALIZER_START
 ...
 */
static void
__attribute__((noinline)) regc(cp, b)
register struct comp *cp;
char b;
{
VIRTUALIZER_START
 ...
 */
static void
__attribute__((noinline)) reginsert(cp, op, opnd)
register struct comp *cp;
char op;
char *opnd;
{
 ...
 */
static void
__attribute__((noinline)) regtail(cp, p, val)
register struct comp *cp;
char *p;
char *val;
{
 ...
 */
static void
__attribute__((noinline)) regoptail(cp, p, val)
register struct comp *cp;
char *p;
char *val;
{
...
__attribute__((noinline)) regtry(ep, prog, string)
 ...
 */
static size_t
__attribute__ ((noinline)) regrepeat(ep, node)
register struct exec *ep;
char *node;
{
VIRTUALIZER_START
 ...
 */
static char *
__attribute__((noinline)) regnext(p)
register char *p;
{
VIRTUALIZER_START
	...
	if (offset == 0)
		return(NULL);
        char *ret = ((OP(p) == BACK) ? p-offset : p+offset);
