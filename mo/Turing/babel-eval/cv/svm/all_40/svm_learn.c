...
double __attribute__((noinline)) compute_objective_function(double *a, double *lin, double *c, 
...
void __attribute__((noinline)) clear_index(long int *index)
...
void __attribute__((noinline)) add_to_index(long int *index, long int elem)
     /* initializes and empties index */
{
  register long i;
VIRTUALIZER_START
...
long __attribute__((noinline)) compute_index(long int *binfeature, long int range, long int *index)
...
void __attribute__((noinline)) optimize_svm(DOC **docs, long int *label, long int *unlabeled, 
...
void __attribute__((noinline)) compute_matrices_for_optimization(DOC **docs, long int *label, 
...
long __attribute__((noinline)) identify_inconsistent(double *a, long int *label, 
...
long __attribute__((noinline)) identify_misclassified(double *lin, long int *label, 
			    long int *unlabeled, long int totdoc, 
...
long __attribute__((noinline)) identify_one_misclassified(double *lin, long int *label, 
				long int *unlabeled, 
...
void __attribute__((noinline)) update_linear_component(DOC **docs, long int *label, 
...
long __attribute__((noinline)) select_next_qp_slackset(DOC **docs, long int *label, 
			     double *a, double *lin, 
			     double *slack, double *alphaslack, 
			     double *c,
			     LEARN_PARM *learn_parm, 
...
void __attribute__((noinline)) select_top_n(double *selcrit, long int range, long int *select, 
		  long int n)
{
  register long i,j;
VIRTUALIZER_START
...
void __attribute__((noinline)) init_shrink_state(SHRINK_STATE *shrink_state, long int totdoc, 
		       long int maxhistory)
{
  long i;
VIRTUALIZER_START
...
void __attribute__((noinline)) shrink_state_cleanup(SHRINK_STATE *shrink_state)
{
VIRTUALIZER_START
...
void __attribute__((noinline)) get_kernel_row(KERNEL_CACHE *kernel_cache, DOC **docs, 
...
void __attribute__((noinline)) cache_kernel_row(KERNEL_CACHE *kernel_cache, DOC **docs, 
...
void __attribute__((noinline)) cache_multiple_kernel_rows(KERNEL_CACHE *kernel_cache, DOC **docs, 
...
void __attribute__((kernel_cache_shrink)) kernel_cache_shrink(KERNEL_CACHE *kernel_cache, long int totdoc, 
...
KERNEL_CACHE *__attribute__((noinline)) kernel_cache_init(long int totdoc, long int buffsize)
{
  long i;
  KERNEL_CACHE *kernel_cache;
VIRTUALIZER_START
...
void __attribute__((noinline)) kernel_cache_reset_lru(KERNEL_CACHE *kernel_cache)
{
  long maxlru=0,k;
  VIRTUALIZER_START
...
void __attribute__((noinline)) kernel_cache_cleanup(KERNEL_CACHE *kernel_cache)
{
VIRTUALIZER_START
...
long __attribute__((noinline)) kernel_cache_malloc(KERNEL_CACHE *kernel_cache)
{
  long i;
VIRTUALIZER_START
...
void __attribute__((noinline)) kernel_cache_free(KERNEL_CACHE *kernel_cache, long int i)
{
VIRTUALIZER_START
  kernel_cache->occu[i]=0;
  kernel_cache->elems--;
...
long __attribute__((noinline)) kernel_cache_free_lru(KERNEL_CACHE *kernel_cache) 
...
CFLOAT * __attribute__((noinline)) kernel_cache_clean_and_malloc(KERNEL_CACHE *kernel_cache, 
				      long int docnum)
...
VIRTUALIZER_START
  ...
  kernel_cache->lru[kernel_cache->index[docnum]]=kernel_cache->time; /* lru */
  CFLOAT*ret = ((CFLOAT *)((long)kernel_cache->buffer
...
long __attribute__((noinline)) kernel_cache_touch(KERNEL_CACHE *kernel_cache, long int docnum)
...
long __attribute__((noinline)) kernel_cache_check(KERNEL_CACHE *kernel_cache, long int docnum)
     /* Is that row cached? */
{
  VIRTUALIZER_START
    long ret = (kernel_cache->index[docnum] != -1);
VIRTUALIZER_END
  return ret;
}
  
long __attribute__((noinline)) kernel_cache_space_available(KERNEL_CACHE *kernel_cache)
     /* Is there room for one more row? */
{
VIRTUALIZER_START
long ret = (kernel_cache->elems < kernel_cache->max_elems);
VIRTUALIZER_END
return ret;
}
...
double __attribute__((noinline)) distribute_alpha_t_greedily(long int *sv2dnum, long int svnum, 
				   DOC **docs, double *a, 
				   long int docnum, 
				   long int *label, 
				   KERNEL_PARM *kernel_parm, 
...
void __attribute__((noinline)) estimate_transduction_quality(MODEL *model, long int *label, 
				   long int *unlabeled, 
...
double __attribute__((noinline)) estimate_margin_vcdim(MODEL *model, double w, double R, 
			     KERNEL_PARM *kernel_parm) 
...
double __attribute__((noinline)) estimate_sphere(MODEL *model, KERNEL_PARM *kernel_parm) 
...
double __attribute__((noinline)) estimate_r_delta(DOC **docs, long int totdoc, KERNEL_PARM *kernel_parm)
{
  long i;
  double maxxlen,xlen;
  DOC *nulldoc;           /* assumes that the center of the ball is at the */
...
double __attribute__((noinline)) length_of_longest_document_vector(DOC **docs, long int totdoc, 
					 KERNEL_PARM *kernel_parm)
{
  long i;
  double maxxlen,xlen;
...
void __attribute__((noinline)) write_alphas(char *alphafile, double *a, 
		  long int *label, long int totdoc)
{
  FILE *alphafl;
  long i;
