...
#ifdef _PROTO_
void __attribute__((noinline)) refresh_neighbour_lists( network_t *net )
#else
void __attribute__((noinline)) refresh_neighbour_lists( net )
    network_t *net;
#endif
{
    node_t *node;
...
#ifdef _PROTO_
long __attribute__((noinline)) refresh_potential( network_t *net )
#else
long __attribute__((noinline)) refresh_potential( net )
    network_t *net;
#endif
{
    node_t *node, *tmp;
...
#ifdef _PROTO_
double __attribute__((noinline)) flow_org_cost( network_t *net )
#else
double __attribute__((noinline)) flow_org_cost( net )
    network_t *net;
#endif
{
    arc_t *arc;
...
#ifdef _PROTO_
long __attribute__((noinline)) primal_feasible( network_t *net )
#else
long __attribute__((noinline)) primal_feasible( net )
    network_t *net;
#endif
{
VIRTUALIZER_START
...
#ifdef _PROTO_
long __attribute__((noinline)) dual_feasible( network_t *net )
#else
long __attribute__((noinline)) dual_feasible(  net )
    network_t *net;
#endif
{
VIRTUALIZER_START
...
#ifdef _PROTO_
long __attribute__((noinline)) getfree( 
            network_t *net
            )
#else
long __attribute__((noinline)) getfree( net )
     network_t *net;
#endif
{  
VIRTUALIZER_START
