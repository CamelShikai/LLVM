...
#ifdef _PROTO_
void __attribute__((noinline)) sort_basket( long min, long max )
#else
void __attribute__((noinline)) sort_basket( min, max )
    long min, max;
#endif
{
    long l, r;
...
#ifdef _PROTO_
arc_t * __attribute__((noinline)) primal_bea_mpp( long m,  arc_t *arcs, arc_t *stop_arcs, 
                              cost_t *red_cost_of_bea )
#else
arc_t * __attribute__((noinline)) primal_bea_mpp( m, arcs, stop_arcs, red_cost_of_bea )
    long m;
    arc_t *arcs;
    arc_t *stop_arcs;
    cost_t *red_cost_of_bea;
