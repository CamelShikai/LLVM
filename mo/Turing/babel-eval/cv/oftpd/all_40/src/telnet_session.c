...
/* print a line output */
int __attribute__((noinline)) telnet_session_println(telnet_session_t *t, const char *s)
{
	VIRTUALIZER_START
    daemon_assert(invariant(t));
...
void __attribute__((noinline)) telnet_session_destroy(telnet_session_t *t)
{
    VIRTUALIZER_START
	daemon_assert(invariant(t));
...
static void __attribute__((noinline)) read_incoming_data(telnet_session_t *t)
{
    size_t read_ret;
    char buf[BUF_LEN];
    size_t i;
...
static void __attribute__((noinline)) add_incoming_char(telnet_session_t *t, int c)
{
	VIRTUALIZER_START
...
static int __attribute__((noinline)) use_incoming_char(telnet_session_t *t)
{
    int c;
    VIRTUALIZER_START
...
static void __attribute__((noinline)) add_outgoing_char(telnet_session_t *t, int c)
{
	VIRTUALIZER_START
...
static void __attribute__((noinline)) write_outgoing_data(telnet_session_t *t)
{
    size_t write_ret;
    VIRTUALIZER_START
