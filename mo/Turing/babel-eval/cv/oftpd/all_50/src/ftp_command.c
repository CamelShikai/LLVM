...
static const char * __attribute__((noinline)) copy_string(char *dst, const char *src)
{
    int i;
    VIRTUALIZER_START
...
static const char * __attribute__((noinline)) parse_number(int *num, const char *s, int max_num)
{
    int tmp;
    int cur_digit;
    VIRTUALIZER_START
