...

{
    ...
    if(( in = fopen( net->inputfile, "r")) == ((void *)0) )
        return -1;
    ...
    ((net->max_new_m >= 3) ? (void) (0) : __assert_fail ("net->max_new_m >= 3", "readmin.c", 77, __PRETTY_FUNCTION__));
...
# 108 "readmin.c"
    ...
    {
        net->arcs[3*i-1].cost =
            (cost_t)((-2)*(((net->bigM) > ((long) 1.0e7)) ? (net->bigM) : ((long) 1.0e7)));
