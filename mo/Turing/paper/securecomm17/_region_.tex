\message{ !name(lnicst.tex)}% This is lnicst.tex the demonstration file of the LaTeX macro package for
...
\message{ !name(lnicst.tex) !offset(-3) }
...
\message{ !name(lnicst.tex) !offset(-466) }
