...
\title{Lecture Notes of the Institute\\
for Computer Sciences, Social-Informatics\\
and Telecommunications Engineering:\\[5pt]
...
corresponding Springer class file \verb+SVMultln.cls+ and the
documentclass option \verb+lnicst+. Only if you use
...
Contact Publication Chair. This is usually one of the organizers of the
